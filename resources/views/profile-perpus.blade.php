...
<head>
    ...
    <title>Perpustakaan - PTQ IQRO'</title>
    <link rel="icon" type="image/x-icon" href="logoptq.png">
    <meta name="title" content="Perpustakaan PTQ IQRO – Pusat Literasi, Ilmu, dan Inspirasi Santri Pesantren">
    <meta name="description" content="Perpustakaan Pesantren Tahfizh Al-Qur’an IQRO’ hadir sebagai pusat literasi, sumber ilmu, dan inspirasi bagi santri. Temukan peran, program, dan manfaat perpustakaan pesantren di sini.">
    <meta name="keywords" content="perpustakaan pesantren, perpustakaan PTQ IQRO, literasi santri, program literasi pesantren, manfaat perpustakaan, pustakawan pesantren">
...
<section class="jurnalistik-hero">
  ...
  <div class="container">
    <div class="hero-content">
      <h1 class="hero-title">
        <span class="hero-highlight">Perpustakaan PTQ IQRO</span><br>
        Jantung Literasi & Sumber Inspirasi Santri
      </h1>
  ...
  <div class="container">
    <div class="section-header">
      <h2 class="section-title">
        <span class="title-highlight">Profil</span> Perpustakaan
        <div class="title-underline"></div>
      </h2>
    </div>
    <div class="about-content">
      <div class="about-image">
        <img src="https://ptqiqro.id/public/foto/profileperpus.jpg" alt="Perpustakaan PTQ IQRO" class="featured-image">
        <div class="image-badge">
          <i class="fas fa-book-reader"></i> Literasi Santri
        </div>
      </div>
      <div class="about-text">
        <p class="lead-text">
          <span class="text-highlight">Perpustakaan PTQ IQRO</span> adalah pusat literasi dan sumber inspirasi bagi santri. Berdiri sejak 2019, perpustakaan ini telah menjadi ruang tumbuhnya budaya baca, diskusi ilmiah, dan pengembangan pengetahuan agama maupun umum. Dengan koleksi buku, jurnal, dan kitab yang beragam, perpustakaan mendukung pembelajaran, penelitian, dan kreativitas santri setiap hari.
        </p>
        <div class="features-grid">
          <div class="feature-item">
            <div class="feature-icon"><i class="fas fa-book"></i></div>
            <div class="feature-text">
              <h4>Sumber Pengetahuan Luas</h4>
              <p>Koleksi literatur agama, sains, teknologi, dan sejarah untuk memperkaya wawasan serta mendukung kajian kitab dan tafsir Al-Qur’an.</p>
            </div>
          </div>
          <div class="feature-item">
            <div class="feature-icon"><i class="fas fa-users"></i></div>
            <div class="feature-text">
              <h4>Mendorong Budaya Membaca</h4>
              <p>Program pekan membaca, lomba resensi, dan kunjungan literasi untuk menumbuhkan minat baca dan kreativitas santri.</p>
            </div>
          </div>
          <div class="feature-item">
            <div class="feature-icon"><i class="fas fa-pencil-alt"></i></div>
            <div class="feature-text">
              <h4>Pembinaan Keterampilan Menulis</h4>
              <p>Mendukung santri dalam penulisan makalah, esai, dan karya ilmiah dengan referensi dan pelatihan menulis.</p>
            </div>
          </div>
          <div class="feature-item">
            <div class="feature-icon"><i class="fas fa-chalkboard-teacher"></i></div>
            <div class="feature-text">
              <h4>Pusat Diskusi & Kajian</h4>
              <p>Ruang diskusi ilmiah, kajian kitab, dan penelitian yang mendukung pembelajaran berbasis dalil dan argumentasi logis.</p>
            </div>
          </div>
        </div>
      </div>
...
<section class="jurnalistik-activities">
  <div class="container">
    <div class="section-header">
      <h2 class="section-title">
        <span class="title-highlight">Kegiatan</span> Perpustakaan
        <div class="title-underline"></div>
      </h2>
    </div>
    <div class="activities-grid">
      <div class="activity-card">
        ...
        <h3>Pekan Membaca Santri</h3>
        <p>Program rutin untuk menumbuhkan minat baca, memperkaya kosa kata, dan meningkatkan literasi santri.</p>
        <div class="activity-badge">Literasi</div>
      </div>
      <div class="activity-card">
        <div class="activity-icon"><i class="fas fa-trophy"></i></div>
        <h3>Lomba Menulis Resensi</h3>
        <p>Kompetisi menulis resensi dan karangan bebas untuk mengasah keterampilan menulis dan berpikir kritis.</p>
        <div class="activity-badge">Kompetisi</div>
      </div>
      <div class="activity-card">
        <div class="activity-icon"><i class="fas fa-university"></i></div>
        <h3>Kunjungan Perpustakaan Daerah</h3>
        <p>Kegiatan kunjungan ke perpustakaan umum untuk memperluas wawasan dan pengalaman literasi santri.</p>
        <div class="activity-badge">Kunjungan</div>
      </div>
      <div class="activity-card">
        <div class="activity-icon"><i class="fas fa-users-cog"></i></div>
        <h3>Kolaborasi Jurnalistik</h3>
        <p>Kolaborasi dengan tim jurnalistik dalam pelatihan menulis, diskusi, dan publikasi karya santri.</p>
...
<!--    <div class="section-header">-->
<!--      <h2 class="section-title">-->
<!--        <span class="title-highlight">Galeri</span> Perpustakaan-->
<!--        <div class="title-underline"></div>-->
<!--      </h2>-->
<!--      <p class="section-subtitle">Momen literasi, diskusi, dan kreativitas santri di Perpustakaan PTQ IQRO</p>-->
<!--    </div>-->
<!--    <div class="gallery-grid">-->
<!--      <div class="gallery-item">-->
<!--        <img src="https://ptqiqro.id/public/foto/1.jpg" alt="Pekan Membaca">-->
<!--        <div class="gallery-overlay">-->
<!--          <div class="gallery-info">-->
<!--            <h3>Pekan Membaca</h3>-->
<!--            <p>Santri antusias membaca buku pilihan untuk memperluas wawasan.</p>-->
<!--          </div>-->
<!--        </div>-->
<!--      </div>-->
<!--      <div class="gallery-item">-->
<!--        <img src="https://ptqiqro.id/public/foto/2.jpg" alt="Lomba Resensi">-->
<!--        <div class="gallery-overlay">-->
<!--          <div class="gallery-info">-->
<!--            <h3>Lomba Resensi</h3>-->
<!--            <p>Kompetisi menulis resensi buku sebagai ajang kreativitas santri.</p>-->
<!--          </div>-->
<!--        </div>-->
<!--      </div>-->
<!--      <div class="gallery-item">-->
<!--        <img src="https://ptqiqro.id/public/foto/4.jpg" alt="Diskusi Ilmiah">-->
<!--        <div class="gallery-overlay">-->
<!--          <div class="gallery-info">-->
<!--            <h3>Diskusi Ilmiah</h3>-->
<!--            <p>Diskusi dan kajian kitab bersama pustakawan dan guru, menumbuhkan budaya berpikir kritis.</p>-->
<!--          </div>-->
<!--        </div>-->
<!--      </div>-->
<!--      <div class="gallery-item">-->
<!--        <img src="https://ptqiqro.id/public/foto/3.jpg" alt="Kunjungan Perpustakaan">-->
<!--        <div class="gallery-overlay">-->
<!--          <div class="gallery-info">-->
<!--            <h3>Kunjungan Perpustakaan</h3>-->
<!--            <p>Santri belajar dan berdiskusi di perpustakaan daerah, menambah pengalaman baru.</p>-->
<!--          </div>-->
<!--        </div>-->
<!--      </div>-->
<!--      <div class="gallery-item">-->
...
<!--      </div>-->
<!--      <div class="gallery-item">-->
<!--        <img src="https://ptqiqro.id/public/foto/5.jpg" alt="Kolaborasi Jurnalistik">-->
<!--        <div class="gallery-overlay">-->
<!--          <div class="gallery-info">-->
<!--            <h3>Kolaborasi Jurnalistik</h3>-->
<!--            <p>Pelatihan menulis dan publikasi karya santri bersama tim jurnalistik PTQ IQRO.</p>-->
<!--          </div>-->
<!--        </div>-->
<!--      </div>-->
<!--    </div>-->
...
<section class="jurnalistik-narasi">
  <div class="container">
    <div class="section-header">
      <h2 class="section-title">
        <span class="title-highlight">Tentang</span> Perpustakaan PTQ IQRO
        <div class="title-underline"></div>
      </h2>
    </div>
...
.jurnalistik-hero {
  ...
  background: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)),
              url('https://ptqiqro.id/public/foto/heroperpus.jpg') center center no-repeat;
