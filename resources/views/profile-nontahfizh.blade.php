...
<head>
 <meta charset="utf-8">
    ...
    <title>Nontahfizh - PTQ IQRO'</title>
    <link rel="icon" type="image/x-icon" href="logoptq.png">
    <meta name="title" content="Pendidikan Islam di PTQ IQRO’ Bekasi | Program Akademik & Pengembangan Karakter Santri">
    <meta name="description" content="PTQ IQRO’ Bekasi menawarkan program pendidikan Islam komprehensif dengan fokus pada pengembangan akademik, pembinaan karakter, dan penguasaan ilmu agama secara mendalam.">
    <meta name="keywords" content="pendidikan Islam Bekasi, program akademik pesantren, pembinaan karakter santri, pengajaran ilmu agama, pesantren PTQ IQRO, pendidikan Islam modern, pengembangan santri, lembaga pendidikan Islam">
...
<section class="hero-section">
  ...
  <div class="container">
    <div class="hero-content" data-aos="fade-up">
      <h1 class="hero-title">
        <span class="hero-highlight">NON-TAHFIZH</span> PTQ IQRO'</h1>
      <p class="hero-subtitle">Program non-tahfizh di PTQ IQRO' meliputi pembelajaran ilmu akademik dan pembinaan karakter untuk membentuk santri yang berakhlak dan berilmu.
...
.hero-section {
  ...
  background: linear-gradient(rgba(0, 0, 0, 0.4), rgba(0, 0, 0, 0.4)), 
              url('https://ptqiqro.id/public/foto/28.jpg') center/cover no-repeat;
  display: flex;
  align-items: center;
  justify-content: center;
  color: white;
...
<!--NON-TAHFIZH SECTION -->
<section class="content-section" style="background-color: #f8f9fa; padding: 40px 0;" id="non-tahfizh">
    <div class="container" style="max-width: 1200px; margin: 0 auto; padding: 0 20px;" id="about">
        <div class="content-card" style="background: white; border-radius: 15px; box-shadow: 0 10px 30px rgba(0,0,0,0.1); overflow: hidden;">
            ...
            <div class="content-header" style="background: linear-gradient(135deg, #1a7446 0%, #1a7446 70%, #fad25d 100%); padding: 30px; color: white;">
                <h3 class="content-header-title" style="margin: 0; font-size: 28px; font-weight: 700;">Kurikulum <span style="color: #fad25d;">Non Tahfizh</span> PTQ IQRO</h3>
                <p class="content-header-subtitle" style="margin: 10px 0 0; font-size: 18px; opacity: 0.9;">Pendidikan Seimbang antara <span style="font-weight: 600; color: #fad25d;">Ilmu Umum dan Agama</span></p>
            </div>
            ...
            <div class="content-body" style="padding: 30px;">
                ...
                <div class="section-block" style="margin-bottom: 40px;">
                    ...
                    <p style="line-height: 1.8; color: #555;">
                        Kurikulum Non Tahfizh di PTQ IQRO' dirancang untuk memberikan pendidikan yang seimbang antara ilmu umum dan ilmu agama. Program ini bertujuan membentuk santri yang tidak hanya menguasai hafalan Al-Qur'an, tetapi juga memiliki wawasan luas dalam berbagai bidang ilmu serta karakter yang kuat berdasarkan nilai-nilai Islam. Dengan pendekatan pembelajaran yang menyeluruh, santri dibekali kemampuan akademik sekaligus pemahaman agama yang mendalam, sehingga siap menghadapi tantangan dunia modern tanpa meninggalkan akhlak mulia.
                    </p>
                </div>
                
                <div class="section-block" style="margin-bottom: 40px;">
                    <h3 class="section-title" style="font-size: 24px; color: #1a7446; margin-bottom: 20px; position: relative; padding-bottom: 10px;">
                        Mata <span style="color: #f5b700;">Pelajaran</span>
                        <span style="position: absolute; bottom: 0; left: 0; width: 60px; height: 3px; background: #f5b700;"></span>
                    </h3>
                    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 20px;">
                        <div style="background: #f9f9f9; border-radius: 10px; padding: 20px; box-shadow: 0 5px 15px rgba(0,0,0,0.05); border-left: 4px solid #1a7446;">
                            <h4 style="color: #1a7446; margin-top: 0;">Ilmu Umum</h4>
                            <ul style="padding-left: 20px; color: #555;">
                                <li style="margin-bottom: 8px;">Matematika</li>
                                <li style="margin-bottom: 8px;">Bahasa Inggris</li>
                                <li style="margin-bottom: 8px;">IPA</li>
                                <li>IPS (Sejarah, Ekonomi, Geografi, Sosiologi)</li>
                                <li style="margin-bottom: 8px;">Bahasa Indonesia</li>
                                <li style="margin-bottom: 8px;">Test TOEFL</li>
                       
                                
                        </div>
                        <div style="background: #f9f9f9; border-radius: 10px; padding: 20px; box-shadow: 0 5px 15px rgba(0,0,0,0.05); border-left: 4px solid #f5b700;">
                            <h4 style="color: #1a7446; margin-top: 0;">Ilmu Agama</h4>
                            <ul style="padding-left: 20px; color: #555;">
                                <li style="margin-bottom: 8px;">Bahasa Arab</li>
                                <li style="margin-bottom: 8px;">Sejarah Islam</li>
                                <li style="margin-bottom: 8px;">Adab</li>
                                <li>Tajwid, Hadits, Ushul Fiqih</li>
                                <li style="margin-bottom: 8px;">Ushul Hadits</li>
                                <li style="margin-bottom: 8px;">Ushul Tafsir</li>
                                <li style="margin-bottom: 8px;">Nahwu</li>
                                <li style="margin-bottom: 8px;">Shorof</li>
                                <li style="margin-bottom: 8px;">Fikih</li>
                                <li style="margin-bottom: 8px;">Ushul Fikih</li>
                        </div>
                    </div>
                </div>
                ...
                <div class="section-block" style="margin-bottom: 40px;" id="visimisi">
                    <h3 class="section-title" style="font-size: 24px; color: #1a7446; margin-bottom: 20px; position: relative; padding-bottom: 10px;">
                        Struktur <span style="color: #f5b700;">Pembelajaran</span>
                        <span style="position: absolute; bottom: 0; left: 0; width: 60px; height: 3px; background: #f5b700;"></span>
                    </h3>
                    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 20px;">
                        <div style="background: #f9f9f9; border-radius: 8px; padding: 20px; box-shadow: 0 5px 15px rgba(0,0,0,0.05);">
                            <div style="display: flex; align-items: center; margin-bottom: 15px;">
                                <div style="background: #1a7446; color: white; width: 40px; height: 40px; border-radius: 50%; display: flex; align-items: center; justify-content: center; margin-right: 15px; font-weight: bold;">1</div>
                                <h4 style="margin: 0; color: #1a7446;">Jadwal Pembelajaran</h4>
                            </div>
                            <ul style="padding-left: 20px; color: #555; margin: 0;">
                                <li style="margin-bottom: 8px;">Senin-Jumat, pukul 09:45-14:00 WIB</li>
                                <li>Total 60 jam per bulan</li>
                            </ul>
                        </div>
                        <div style="background: #f9f9f9; border-radius: 8px; padding: 20px; box-shadow: 0 5px 15px rgba(0,0,0,0.05);">
                            <div style="display: flex; align-items: center; margin-bottom: 15px;">
                                <div style="background: #f5b700; color: white; width: 40px; height: 40px; border-radius: 50%; display: flex; align-items: center; justify-content: center; margin-right: 15px; font-weight: bold;">2</div>
                                <h4 style="margin: 0; color: #1a7446;">Evaluasi</h4>
                            </div>
                            <ul style="padding-left: 20px; color: #555; margin: 0;">
                                <li style="margin-bottom: 8px;">Penilaian Tengah dan Akhir Semester</li>
                                <li>Ujian Praktek dan Ujian Sekolah</li>
                            </ul>
                        </div>
                        <div style="background: #f9f9f9; border-radius: 8px; padding: 20px; box-shadow: 0 5px 15px rgba(0,0,0,0.05);">
                            <div style="display: flex; align-items: center; margin-bottom: 15px;">
                                <div style="background: #1a7446; color: white; width: 40px; height: 40px; border-radius: 50%; display: flex; align-items: center; justify-content: center; margin-right: 15px; font-weight: bold;">3</div>
                                <h4 style="margin: 0; color: #1a7446;">Kurikulum</h4>
                            </div>
                            <ul style="padding-left: 20px; color: #555; margin: 0;">
                                <li style="margin-bottom: 8px;">Kurikulum 2013 dan Kurikulum Merdeka</li>
                                <li>SMP menginduk Paket B, SMA menginduk SMAN 17 Bekasi</li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="section-block">
                    ...
                    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 20px;">
                        <div style="background: #f9f9f9; padding: 20px; border-radius: 8px; box-shadow: 0 5px 15px rgba(0,0,0,0.05); border-top: 3px solid #1a7446;">
                            <h4 style="color: #1a7446; margin-top: 0;">Pendidikan Seimbang</h4>
                            <p style="color: #555; margin-bottom: 0;">Mengintegrasikan ilmu umum dan agama secara harmonis.</p>
                        </div>
                        <div style="background: #f9f9f9; padding: 20px; border-radius: 8px; box-shadow: 0 5px 15px rgba(0,0,0,0.05); border-top: 3px solid #f5b700;">
                            <h4 style="color: #1a7446; margin-top: 0;">Pengembangan Karakter</h4>
                            <p style="color: #555; margin-bottom: 0;">Menanamkan nilai-nilai akhlak mulia dan keislaman.</p>
                        </div>
                        <div style="background: #f9f9f9; padding: 20px; border-radius: 8px; box-shadow: 0 5px 15px rgba(0,0,0,0.05); border-top: 3px solid #1a7446;">
                            <h4 style="color: #1a7446; margin-top: 0;">Metode Variatif</h4>
                            <p style="color: #555; margin-bottom: 0;">Kombinasi teori, diskusi, dan praktik.</p>
                        </div>
                        <div style="background: #f9f9f9; padding: 20px; border-radius: 8px; box-shadow: 0 5px 15px rgba(0,0,0,0.05); border-top: 3px solid #f5b700;">
                            <h4 style="color: #1a7446; margin-top: 0;">Evaluasi Komprehensif</h4>
                            <p style="color: #555; margin-bottom: 0;">Menjamin pemahaman teori dan kemampuan aplikasi.</p>
                        </div>
                        <div style="background: #f9f9f9; padding: 20px; border-radius: 8px; box-shadow: 0 5px 15px rgba(0,0,0,0.05); border-top: 3px solid #1a7446;">
                            <h4 style="color: #1a7446; margin-top: 0;">Fleksibilitas</h4>
                            <p style="color: #555; margin-bottom: 0;">Menggunakan Kurikulum Merdeka yang adaptif.</p>
                        </div>
                    </div>
                </div>
            </div>
