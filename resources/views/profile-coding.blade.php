...
<head>
    ...
    <title>Coding - PTQ IQRO'</title>
    <link rel="icon" type="image/x-icon" href="logoptq.png">
    <meta name="title" content="Tim Coding PTQ IQRO | Ujung Tombak Digitalisasi Pesantren dan Inovasi Teknologi">
    <meta name="description" content="Kenali Tim Coding PTQ IQRO yang berani berinovasi dari nol, menciptakan website laporan hafalan santri ptqiqro.id, dan menjadi ujung tombak digitalisasi pesantren tahfizh modern.">
    <meta name="keywords" content="Tim Coding PTQ IQRO, digitalisasi pesantren, website hafalan santri, ptqiqro.id, inovasi teknologi pesantren, transformasi digital pesantren">
...
<section class="jurnalistik-hero">
  ...
  <div class="container">
    <div class="hero-content">
      <h1 class="hero-title">
        <span class="hero-highlight">Tim Coding PTQ IQRO</span><br>
        Ujung Tombak Digitalisasi Pesantren
      </h1>
      <p class="hero-subtitle">
        Dari nol coding, berani berinovasi – membangun masa depan pesantren dengan teknologi!
      </p>
      <div class="social-links">
        <a href="https://ptqiqro.id" class="social-link"><i class="fas fa-globe"></i></a>
        <!-- Tambahkan link IG/YouTube jika ada -->
      </div>
    </div>
  </div>
</section>
  ...
  <div class="container">
    <div class="section-header">
      <h2 class="section-title">
        <span class="title-highlight">Profil</span> Tim Coding
        <div class="title-underline"></div>
      </h2>
    </div>
    <div class="about-content">
      <div class="about-image">
        <img src="https://ptqiqro.id/public/foto/54.jpg" alt="Tim Coding PTQ IQRO" class="featured-image">
        <div class="image-badge">
          <i class="fas fa-code"></i> Digitalisasi Pesantren
        </div>
      </div>
      <div class="about-text">
        <p class="lead-text">
          <span class="text-highlight">Tim Coding PTQ IQRO</span> adalah tim inovatif yang menjadi ujung tombak digitalisasi di lingkungan Pesantren Tahfizh Qur’an IQRO Bekasi. Meski berawal tanpa pengalaman coding, mereka berani menerima tantangan besar: membangun website laporan hafalan santri dari nol hingga lahirlah <b>ptqiqro.id</b>.
        </p>
        <div class="features-grid">
          <div class="feature-item">
            <div class="feature-icon"><i class="fas fa-users-cog"></i></div>
            <div class="feature-text">
              <h4>Belajar dari Nol</h4>
              <p>Anggota tim awalnya belum punya basic coding, namun berani belajar dan langsung praktik proyek nyata.</p>
            </div>
          </div>
          <div class="feature-item">
            <div class="feature-icon"><i class="fas fa-laptop-code"></i></div>
            <div class="feature-text">
              <h4>Membangun Website</h4>
              <p>Mengembangkan <b>ptqiqro.id</b> sebagai platform digital laporan hafalan santri dan pusat informasi pesantren.</p>
            </div>
          </div>
          <div class="feature-item">
            ...
            <div class="feature-text">
              ...
              <p>Terus berinovasi dengan mengembangkan aplikasi dan sistem digital lain untuk mendukung seluruh program pesantren.</p>
            </div>
          </div>
          <div class="feature-item">
            <div class="feature-icon"><i class="fas fa-heart"></i></div>
            <div class="feature-text">
              <h4>Semangat Kolaborasi</h4>
              <p>Bekerja sama lintas angkatan, belajar bersama, dan saling mendukung untuk kemajuan pesantren.</p>
            </div>
          </div>
        </div>
      </div>
  ...
  <div class="container">
    ...
    <div class="activities-grid">
      ...
      <div class="activity-card">
        <div class="activity-icon"><i class="fas fa-globe"></i></div>
        <h3>Pengembangan Website</h3>
        <p>Membuat dan mengelola <b>ptqiqro.id</b> sebagai pusat data hafalan, administrasi, dan informasi pesantren.</p>
        <div class="activity-badge">Proyek Utama</div>
      </div>
      <!-- 2. Digitalisasi Laporan Hafalan -->
      <div class="activity-card">
        <div class="activity-icon"><i class="fas fa-database"></i></div>
        <h3>Digitalisasi Laporan Hafalan</h3>
        <p>Mendesain sistem pelaporan hafalan Qur’an santri yang mudah diakses dan transparan untuk ustadz, santri, dan wali.</p>
        <div class="activity-badge">Inovasi</div>
      </div>
      <!-- 3. Pelatihan & Pengembangan Skill -->
      <div class="activity-card">
        <div class="activity-icon"><i class="fas fa-chalkboard-teacher"></i></div>
        <h3>Pelatihan & Pengembangan Skill</h3>
        <p>Belajar bersama, mentoring, dan berbagi ilmu coding antar anggota tim untuk meningkatkan skill digital santri.</p>
        <div class="activity-badge">Rutin</div>
      </div>
      <!-- 4. Dukungan Teknis Program Pesantren -->
      <div class="activity-card">
        <div class="activity-icon"><i class="fas fa-tools"></i></div>
        <h3>Dukungan Teknis</h3>
        <p>Mendukung kelancaran seluruh program pesantren dengan solusi teknologi, troubleshooting, dan perbaikan sistem.</p>
        <div class="activity-badge">Support</div>
      </div>
    </div>
  </div>
</section>
...
<section class="jurnalistik-narasi">
  <div class="container">
    <div class="section-header">
      <h2 class="section-title">
        <span class="title-highlight">Tentang</span> Tim Coding PTQ IQRO
        <div class="title-underline"></div>
      </h2>
    </div>
    <div class="narasi-content">
      <p>
        Di era digital, transformasi teknologi menjadi kebutuhan utama bagi pesantren modern. PTQ IQRO Bekasi menjawab tantangan ini dengan membentuk <b>Tim Coding PTQ IQRO</b>—sekelompok santri yang menjadi ujung tombak digitalisasi pesantren. Uniknya, para anggota tim ini awalnya belum memiliki pengalaman coding, namun dengan semangat belajar dan keberanian, mereka langsung dipercaya mengerjakan proyek besar: membangun website laporan hafalan Qur’an santri.
      </p>
      <p>
        Melalui proses belajar mandiri, kolaborasi, dan kerja keras, lahirlah <b>ptqiqro.id</b>, platform digital yang kini menjadi pusat data hafalan, administrasi, dan informasi pesantren. Website ini memudahkan monitoring perkembangan hafalan santri secara real-time, meningkatkan efisiensi administrasi, serta memperkuat komunikasi antara santri, ustadz, dan wali santri.
      </p>
      <p>
        Tidak berhenti di situ, Tim Coding terus berinovasi dengan mengembangkan aplikasi dan sistem digital lain untuk mendukung seluruh program pesantren. Mereka aktif belajar, saling berbagi ilmu, dan menjadi inspirasi bagi santri lain untuk tidak takut mencoba hal baru di bidang teknologi.
      </p>
      <p>
        Keberhasilan Tim Coding PTQ IQRO adalah bukti nyata bahwa keterbatasan bukan penghalang untuk berprestasi. Dengan dukungan pesantren dan semangat pantang menyerah, mereka menjadi agen perubahan yang membawa pesantren ke era digital. Apresiasi setinggi-tingginya patut diberikan kepada Tim Coding PTQ IQRO atas dedikasi, inovasi, dan kontribusinya dalam membangun masa depan pesantren yang lebih modern dan efisien.
      </p>
    </div>
  </div>
</section>
...
.jurnalistik-hero {
  position: relative;
  height: 100vh;
  min-height: 500px;gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)),
              url('https://ptqiqro.id/public/foto/47.jpg') center center no-repeat;
