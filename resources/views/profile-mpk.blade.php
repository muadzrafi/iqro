...
<head>
    ...
    <title>MPK - PTQ IQRO'</title>
    <link rel="icon" type="image/x-icon" href="logoptq.png">
    <meta name="title" content="TimMPK PTQ IQRO – Majelis Perwakilan Kamar Pengawas ISQI & Organisasi Pesantren">
    <meta name="description" content="Majelis Perwakilan Kamar (MPK) PTQ IQRO adalah lembaga pengawasan dan penyalur aspirasi santri yang mengawasi ISQI (OSIS), DKM, Keolahragaan, Media Kesantrian, dan Perpustakaan. MPK terdiri dari ketua, wakil, dan perwakilan tiap kamar, berperan sebagai jembatan kritik, saran, dan musyawarah untuk kemajuan pesantren.">
    <meta name="keywords" content="TimMPK PTQ IQRO, Majelis Perwakilan Kamar, pengawas ISQI, organisasi santri pesantren, pengawasan organisasi pesantren, penyalur aspirasi santri, OSIS PTQ IQRO, ISQI, DKM PTQ IQRO, keolahragaan pesantren, media kesantrian, perpustakaan pesantren, musyawarah santri">
...
<section class="jurnalistik-hero">
  ...
  <div class="container">
    <div class="hero-content">
      <h1 class="hero-title">
        <span class="hero-highlight">MPK PTQ IQRO</span><br>
        Majelis Perwakilan Kamar
      </h1>
      <p class="hero-subtitle">
        Lembaga pengawasan, musyawarah, dan penyalur aspirasi santri untuk ISQI, organisasi pesantren, dan seluruh civitas PTQ IQRO.
      </p>
  ...
  <div class="container">
    <div class="section-header">
      <h2 class="section-title">
        <span class="title-highlight">Profil</span> MPK
        <div class="title-underline"></div>
      </h2>
    </div>
    <div class="about-content">
      <div class="about-image">
        <img src="https://ptqiqro.id/public/foto-profile-pengasuhan/mpk/homempk.jpg" alt="MPK PTQ IQRO" class="featured-image">
        <div class="image-badge">
          <i class="fas fa-balance-scale"></i> Pengawasan & Aspirasi
        </div>
      </div>
      <div class="about-text">
        <p class="lead-text">
          <span class="text-highlight">MPK (Majelis Perwakilan Kamar)</span> adalah organisasi pengawas utama di PTQ IQRO, beranggotakan ketua, wakil, dan perwakilan tiap kamar (ketua kamar). MPK bertugas mengawasi kinerja dan seluruh program ISQI (Ikatan Santri Qur'an IQRO) serta organisasi lain seperti DKM, Keolahragaan, Media Kesantrian, dan Perpustakaan. Selain itu, MPK menjadi jembatan kritik, saran, dan musyawarah antara santri, ISQI, organisasi lain, dan pihak pesantren.
        </p>
        <div class="features-grid">
          <div class="feature-item">
            <div class="feature-icon"><i class="fas fa-users-cog"></i></div>
            <div class="feature-text">
              <h4>Struktur Sederhana</h4>
              <p>Ketua, wakil, dan anggota dari perwakilan tiap kamar, menjamin aspirasi seluruh santri terwakili.</p>
            </div>
          </div>
          <div class="feature-item">
            <div class="feature-icon"><i class="fas fa-eye"></i></div>
            <div class="feature-text">
              <h4>Pengawasan Program</h4>
              <p>Mengawasi seluruh program dan kegiatan ISQI serta organisasi lain agar berjalan sesuai visi pesantren.</p>
            </div>
          </div>
          <div class="feature-item">
            <div class="feature-icon"><i class="fas fa-comments"></i></div>
            <div class="feature-text">
              <h4>Penyalur Aspirasi</h4>
              <p>Menjadi wadah kritik, saran, dan solusi bagi seluruh santri kepada ISQI, organisasi, maupun pihak pesantren.</p>
            </div>
          </div>
          <div class="feature-item">
            <div class="feature-icon"><i class="fas fa-handshake"></i></div>
            <div class="feature-text">
              <h4>Jembatan Komunikasi</h4>
              <p>Menghubungkan santri, organisasi, dan pimpinan pesantren secara demokratis dan harmonis.</p>
            </div>
          </div>
        </div>
      </div>
...
<section class="jurnalistik-activities">
  <div class="container">
    <div class="section-header">
      <h2 class="section-title">
        <span class="title-highlight">Peran</span> & Kegiatan MPK
        <div class="title-underline"></div>
      </h2>
    </div>
    <div class="activities-grid">
      <div class="activity-card">
        <div class="activity-icon"><i class="fas fa-balance-scale"></i></div>
        <h3>Pengawasan ISQI</h3>
        <p>Memastikan seluruh program dan kegiatan ISQI berjalan sesuai aturan dan kebutuhan santri.</p>
        <div class="activity-badge">Utama</div>
      </div>
      <div class="activity-card">
        <div class="activity-icon"><i class="fas fa-users"></i></div>
        <h3>Pengawasan Organisasi Lain</h3>
        <p>Mengawasi DKM, Keolahragaan, Media Kesantrian, dan Perpustakaan agar tetap sinergis dan transparan.</p>
        <div class="activity-badge">Sinergi</div>
      </div>
      <div class="activity-card">
        <div class="activity-icon"><i class="fas fa-comment-dots"></i></div>
        <h3>Musyawarah & Aspirasi</h3>
        <p>Menampung kritik dan saran dari santri, lalu menyampaikannya ke ISQI, organisasi, atau pihak pesantren.</p>
        <div class="activity-badge">Aspirasi</div>
      </div>
      <div class="activity-card">
        <div class="activity-icon"><i class="fas fa-handshake"></i></div>
        <h3>Jembatan Komunikasi</h3>
        <p>Menghubungkan santri, organisasi, dan pimpinan pesantren dalam suasana demokratis dan harmonis.</p>
        <div class="activity-badge">Kolaborasi</div>
      </div>
    </div>
  </div>
</section>
...
<!--    <div class="section-header">-->
<!--      <h2 class="section-title">-->
<!--        <span class="title-highlight">Galeri</span> MPK-->
<!--        <div class="title-underline"></div>-->
<!--      </h2>-->
<!--      <p class="section-subtitle">Momen musyawarah, pengawasan, dan kolaborasi MPK PTQ IQRO</p>-->
<!--    </div>-->
<!--    <div class="gallery-grid">-->
<!--      <div class="gallery-item">-->
<!--        <img src="https://ptqiqro.id/public/foto/1.jpg" alt="Musyawarah MPK">-->
<!--        <div class="gallery-overlay">-->
<!--          <div class="gallery-info">-->
<!--            <h3>Musyawarah MPK</h3>-->
<!--            <p>Diskusi dan musyawarah anggota MPK bersama perwakilan kamar.</p>-->
<!--          </div>-->
<!--        </div>-->
<!--      </div>-->
<!--      <div class="gallery-item">-->
<!--        <img src="https://ptqiqro.id/public/foto/2.jpg" alt="Pengawasan ISQI">-->
<!--        <div class="gallery-overlay">-->
<!--          <div class="gallery-info">-->
<!--            <h3>Pengawasan ISQI</h3>-->
<!--            <p>MPK mengawasi pelaksanaan program dan kegiatan ISQI.</p>-->
<!--          </div>-->
<!--        </div>-->
<!--      </div>-->
<!--      <div class="gallery-item">-->
<!--        <img src="https://ptqiqro.id/public/foto/3.jpg" alt="Kolaborasi Organisasi">-->
<!--        <div class="gallery-overlay">-->
<!--          <div class="gallery-info">-->
<!--            <h3>Kolaborasi Organisasi</h3>-->
<!--            <p>MPK bersama DKM, Keolahragaan, Media Kesantrian, dan Perpustakaan.</p>-->
<!--          </div>-->
<!--        </div>-->
<!--      </div>-->
<!--      <div class="gallery-item">-->
<!--        <img src="https://ptqiqro.id/public/foto/4.jpg" alt="Aspirasi Santri">-->
<!--        <div class="gallery-overlay">-->
<!--          <div class="gallery-info">-->
<!--            <h3>Aspirasi Santri</h3>-->
<!--            <p>MPK menampung dan menyalurkan kritik serta saran dari seluruh santri.</p>-->
<!--          </div>-->
<!--        </div>-->
<!--      </div>-->
<!--    </div>-->
...
<section class="jurnalistik-narasi">
  <div class="container">
    <div class="section-header">
      <h2 class="section-title">
        <span class="title-highlight">Tentang</span> MPK PTQ IQRO
        <div class="title-underline"></div>
      </h2>
    </div>
    <div class="narasi-content">
      <p>
        MPK (Majelis Perwakilaman Kamar) PTQ IQRO adalah organisasi pengawas dan penyalur aspirasi santri yang beranggotakan ketua, wakil, dan perwakilan tiap kamar (ketua kamar). MPK bertugas mengawasi kinerja dan seluruh program ISQI (Ikatan Santri Qur'an IQRO) yang merupakan OSIS di lingkungan pesantren, serta mengawasi organisasi lain seperti DKM, Keolahragaan, Media Kesantrian, dan Perpustakaan.
      </p>
      <p>
        MPK menjadi lembaga utama untuk menampung kritik, saran, dan musyawarah dari seluruh santri. Setiap anggota MPK adalah perwakilan kamar, sehingga suara dan aspirasi santri dari berbagai latar belakang dapat tersampaikan secara adil dan demokratis. MPK juga berperan sebagai penghubung antara santri, ISQI, organisasi lain, dan pihak pesantren, menciptakan komunikasi yang harmonis dan transparan.
      </p>
      <p>
        Dalam menjalankan tugasnya, MPK aktif mengawasi pelaksanaan seluruh program kerja dan kegiatan ISQI, memastikan semuanya berjalan sesuai aturan, visi, dan kebutuhan santri. Selain itu, MPK juga mengawasi organisasi lain agar tetap sinergis, transparan, dan berkontribusi positif untuk lingkungan pesantren.
      </p>
      <p>
        Struktur MPK yang sederhana namun efektif—hanya terdiri dari ketua, wakil, dan anggota perwakilan kamar—membuat organisasi ini sangat responsif terhadap dinamika dan kebutuhan santri. Musyawarah, diskusi, dan kolaborasi rutin menjadi budaya utama dalam MPK, sehingga setiap keputusan diambil secara mufakat dan mengedepankan kepentingan bersama.
      </p>
      <p>
        Dengan peran strategisnya, MPK PTQ IQRO menjadi pilar penting dalam menjaga transparansi, demokrasi, dan keharmonisan kehidupan santri di pesantren. Melalui pengawasan, penyaluran aspirasi, dan kolaborasi lintas organisasi, MPK berkomitmen untuk terus membangun lingkungan pesantren yang kondusif, inspiratif, dan penuh semangat kebersamaan.
      </p>
    </div>
  </div>
</section>
...
.jurnalistik-hero {
  ...
  background: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)),
              url('https://ptqiqro.id/public/foto-profile-pengasuhan/mpk/homempk.jpg') center center no-repeat;
