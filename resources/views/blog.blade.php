...
<section class="hero-section">
  ...
  <div class="container">
    <div class="hero-content" data-aos="fade-up">
      <h1 class="hero-title">
        <span class="hero-highlight">Blog</span> & Berita
      </h1>
      <p class="hero-subtitle">Update terbaru seputar kegiatan dan informasi PTQ IQRO'</p>
    </div>
  </div>
</section>

    <!-- Filter Chips -->
    {{-- <div class="sigma-news-filter">
      <button class="sigma-filter-chip active" data-filter="all">
        <i class="fas fa-layer-group"></i> Semua
      </button>
      <button class="sigma-filter-chip" data-filter="kegiatan">
        <i class="fas fa-mosque"></i> News
      </button>
      <button class="sigma-filter-chip" data-filter="pengumuman">
        <i class="fas fa-bullhorn"></i> Sport
      </button>
    </div> --}}
    <style>
...
:root {
  --iqro-primary: #1a7446;
  --iqro-primary-light: #2d9d64;
  --iqro-secondary: #fad25d;
  --iqro-dark: #0d3b23;
  --iqro-light: #edfafd;
  --iqro-gold: #f5b700;
  --iqro-text: #333333;
  --iqro-text-light: #7a9ca7;
  --iqro-bg: #ffffff;
  --iqro-card-bg: #ffffff;
}
...
.sigma-news-section {
  position: relative;
  padding: 100px 0;
  background-color: var(--iqro-light);
  overflow: hidden;
}
...
.sigma-ornament-right {
  animation-delay: 0.4s;
}

.sigma-section-title-news {
  font-family: 'Poppins', sans-serif;
  font-size: 2.5rem;
  font-weight: 800;
  margin: 0;
  ...
  position: relative;
  color: var(--iqro-dark); /* Fixed: single valid color */
}

.sigma-title-line-news {
  color: var(--iqro-dark);
  position: relative;
  display: inline-block;
}

.sigma-title-highlight-news {
...
.sigma-header-underline {
  width: 80px;
  height: 4px;
  background: linear-gradient(to right, var(--iqro-primary), var(--iqro-secondary));
  margin: 15px auto 0;
  border-radius: 2px;
}

/* Optional: float animation keyframes for ornaments */
@keyframes float {
  0%, 100% {
    transform: translateY(0);
  }
...
.sigma-filter-chip:hover {
  transform: translateY(-2px);
  box-shadow: 0 5px 15px rgba(26, 116, 70, 0.1);
  border-color: var(--iqro-primary-light);
}

.sigma-filter-chip.active {
  background: var(--iqro-primary);
  color: white;
  border-color: var(--iqro-primary);
}

.sigma-filter-chip.active i {
  color: white;
}
</style>
