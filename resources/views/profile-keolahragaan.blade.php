...
<head>
    ...
    <title>Keolahragaan - PTQ IQRO'</title>
    <link rel="icon" type="image/x-icon" href="logoptq.png">
    <meta name="title" content="Keolahragaan PTQ IQRO | Pengembangan Kesehatan dan Semangat Santri">
    <meta name="description" content="Keolahragaan PTQ IQRO fokus menjaga kesehatan santri melalui futsal, badminton, jogging, dan workout. Dukungan fasilitas diharapkan untuk tingkatkan kualitas olahraga santri.">
    <meta name="keywords" content="Keolahragaan PTQ IQRO fokus menjaga kesehatan santri melalui futsal, badminton, jogging, dan workout. Dukungan fasilitas diharapkan untuk tingkatkan kualitas olahraga santri.">
...
<section class="jurnalistik-hero">
  ...
  <div class="container">
    <div class="hero-content">
      <h1 class="hero-title">
        <span class="hero-highlight">Keolahragaan PTQ IQRO</span><br>
        Sehat, Aktif, dan Berprestasi
      </h1>
      <p class="hero-subtitle">
        Menjaga kesehatan, menumbuhkan semangat, dan membangun karakter santri melalui olahraga yang kreatif dan konsisten.
      </p>
      <!--<div class="social-links">-->
      <!--  <a href="https://www.instagram.com/ptqiqro.putra/" class="social-link instagram"><i class="fab fa-instagram"></i></a>-->
      <!--</div>-->
    </div>
  </div>
</section>
  ...
  <div class="container">
    <div class="section-header">
      <h2 class="section-title">
        <span class="title-highlight">Profil</span> Keolahragaan
        <div class="title-underline"></div>
      </h2>
    </div>
    <div class="about-content">
      <div class="about-image">
        <img src="https://ptqiqro.id/public/foto/79.jpg" alt="Keolahragaan PTQ IQRO" class="featured-image">
        <div class="image-badge">
          <i class="fas fa-dumbbell"></i> Olahraga Santri
        </div>
      </div>
      <div class="about-text">
        <p class="lead-text">
          <span class="text-highlight">Keolahragaan PTQ IQRO</span> adalah program pembinaan fisik yang fokus menjaga kesehatan tubuh dan menumbuhkan semangat santri. Dengan berbagai kegiatan rutin seperti futsal, badminton, jogging, workout day, hingga workout challenge day, santri diajak untuk aktif, kreatif, dan konsisten menjaga kebugaran meski dengan fasilitas yang terbatas.
        </p>
        <div class="features-grid">
          <div class="feature-item">
            ...
            <div class="feature-text">
              <h4>Futsal & Badminton</h4>
              <p>Pertandingan futsal dan badminton rutin untuk meningkatkan kebugaran, kekompakan, dan sportivitas antar santri.</p>
            </div>
          </div>
          <div class="feature-item">
            <div class="feature-icon">
            ...
            <div class="feature-text">
              <h4>Jogging & Workout Day</h4>
              <p>Jogging bersama dan workout day sebagai sarana menjaga stamina, disiplin, dan semangat hidup sehat.</p>
            </div>
          </div>
          <div class="feature-item">
            <div class="feature-icon">
            ...
            <div class="feature-text">
              ...
              <p>Memanfaatkan peralatan seadanya, tim keolahragaan tetap inovatif dan tidak pernah kehabisan ide untuk membuat latihan tetap seru.</p>
            </div>
          </div>
          <div class="feature-item">
            <div class="feature-icon">
            ...
            <div class="feature-text">
              <h4>Olahraga Sambil Murojaah</h4>
              <p>Beberapa santri menggabungkan olahraga dengan murojaah hafalan Qur’an, menjaga keseimbangan fisik dan spiritual.</p>
            </div>
          </div>
        </div>
      </div>
...
<section class="jurnalistik-activities">
  <div class="container">
    <div class="section-header">
      <h2 class="section-title">
        <span class="title-highlight">Kegiatan</span> Olahraga
        <div class="title-underline"></div>
      </h2>
    </div>
    <div class="activities-grid">
      <div class="activity-card">
        ...
        <h3>Futsal & Badminton</h3>
        <p>Pertandingan rutin untuk melatih kekompakan, sportivitas, dan menjaga kebugaran santri.</p>
      ...
      <div class="activity-card">
        ...
        <h3>Jogging Pagi</h3>
        <p>Kegiatan jogging bersama sebagai sarana menjaga stamina dan membangun semangat hidup sehat.</p>
        <div class="activity-badge">Pagi Pilihan</div>
      </div>
      <div class="activity-card">
        <div class="activity-icon">
          <i class="fas fa-dumbbell"></i>
        </div>
        <h3>Workout Day & Challenge</h3>
        <p>Latihan fisik bersama dan tantangan workout untuk mengasah daya tahan, disiplin, dan kreativitas santri.</p>
        <div class="activity-badge">Challenge Day</div>
      </div>
      <div class="activity-card">
        <div class="activity-icon">
          <i class="fas fa-heart"></i>
        </div>
        <h3>Olahraga Sambil Murojaah</h3>
        <p>Kegiatan unik di mana santri murojaah hafalan Qur’an sambil berolahraga, menyeimbangkan fisik dan spiritual.</p>
        <div class="activity-badge">Inspirasi</div>
      </div>
    </div>
  </div>
</section>
...
<!--    <div class="section-header">-->
<!--      <h2 class="section-title">-->
<!--        <span class="title-highlight">Galeri</span> Olahraga-->
<!--        <div class="title-underline"></div>-->
<!--      </h2>-->
<!--      <p class="section-subtitle">Momen-momen kebugaran, kekompakan, dan inspirasi olahraga santri PTQ IQRO</p>-->
<!--    </div>-->
<!--    <div class="gallery-grid">-->
<!--      <div class="gallery-item">-->
<!--        <img src="https://ptqiqro.id/public/foto/1.jpg" alt="Futsal Santri">-->
<!--        <div class="gallery-overlay">-->
<!--          <div class="gallery-info">-->
<!--            <h3>Futsal Santri</h3>-->
<!--            <p>Pertandingan futsal seru yang membangun kekompakan dan sportivitas.</p>-->
<!--          </div>-->
<!--        </div>-->
<!--      </div>-->
<!--      <div class="gallery-item">-->
<!--        <img src="https://ptqiqro.id/public/foto/2.jpg" alt="Badminton Bareng">-->
<!--        <div class="gallery-overlay">-->
<!--          <div class="gallery-info">-->
<!--            <h3>Badminton Bareng</h3>-->
<!--            <p>Latihan badminton bersama untuk menjaga kebugaran tubuh.</p>-->
<!--          </div>-->
<!--        </div>-->
<!--      </div>-->
<!--      <div class="gallery-item">-->
<!--        <img src="https://ptqiqro.id/public/foto/3.jpg" alt="Jogging Pagi">-->
<!--        <div class="gallery-overlay">-->
<!--          <div class="gallery-info">-->
<!--            <h3>Jogging Pagi</h3>-->
<!--            <p>Jogging keliling pesantren, membangun semangat dan stamina.</p>-->
<!--          </div>-->
<!--        </div>-->
<!--      </div>-->
<!--      <div class="gallery-item">-->
<!--        <img src="https://ptqiqro.id/public/foto/4.jpg" alt="Workout Day">-->
<!--        <div class="gallery-overlay">-->
<!--          <div class="gallery-info">-->
<!--            <h3>Workout Day</h3>-->
<!--            <p>Latihan fisik bersama dengan alat seadanya, tetap kreatif dan bugar.</p>-->
<!--          </div>-->
<!--        </div>-->
<!--      </div>-->
<!--      <div class="gallery-item">-->
<!--        <img src="https://ptqiqro.id/public/foto/5.jpg" alt="Workout Challenge">-->
<!--        <div class="gallery-overlay">-->
<!--          <div class="gallery-info">-->
<!--            <h3>Workout Challenge</h3>-->
<!--            <p>Tantangan workout seru untuk menguji daya tahan dan konsistensi santri.</p>-->
<!--          </div>-->
<!--        </div>-->
<!--      </div>-->
<!--      <div class="gallery-item">-->
...
<!--      </div>-->
<!--      <div class="gallery-item">-->
<!--        <img src="https://ptqiqro.id/public/foto/6.jpg" alt="Murojaah Sambil Olahraga">-->
<!--        <div class="gallery-overlay">-->
<!--          <div class="gallery-info">-->
<!--            <h3>Murojaah Sambil Olahraga</h3>-->
<!--            <p>Santri murojaah hafalan Qur’an sambil berolahraga, menyeimbangkan fisik dan spiritual.</p>-->
<!--          </div>-->
<!--        </div>-->
<!--      </div>-->
<!--    </div>-->
...
<section class="jurnalistik-narasi">
  <div class="container">
    <div class="section-header">
      <h2 class="section-title">
        <span class="title-highlight">Tentang</span> Keolahragaan PTQ IQRO
        <div class="title-underline"></div>
      </h2>
    </div>
    <div class="narasi-content">
      <p>
        Keolahragaan di Pondok Pesantren Tahfizh Qur’an (PTQ) IQRO menjadi salah satu aspek penting dalam pembinaan santri. Fokus utama dari kegiatan keolahragaan ini adalah pengembangan dan penjagaan kesehatan tubuh santri agar tetap prima, sehingga mereka mampu menjalankan aktivitas belajar menghafal Al-Qur’an dan kegiatan pesantren lainnya dengan optimal.
      </p>
      <p>
        Berbagai aktivitas olahraga rutin digelar oleh tim keolahragaan PTQ IQRO, seperti futsal, badminton, jogging, workout day, dan workout challenge day. Meskipun fasilitas dan alat olahraga yang tersedia masih terbatas, semangat dan kreativitas tim keolahragaan serta para santri tidak pernah surut. Mereka mampu memanfaatkan peralatan yang ada secara maksimal untuk menjaga kebugaran dan kesehatan tubuh.
      </p>
      <p>
        Salah satu momen yang sangat menginspirasi adalah ketika beberapa santri melakukan workout sambil murojaah hafalan Al-Qur’an. Hal ini menunjukkan keseimbangan yang luar biasa antara pengembangan fisik dan spiritual, sekaligus menegaskan bahwa menjaga kesehatan jasmani adalah bagian integral dari pembinaan karakter dan keimanan di pesantren.
      </p>
      <p>
        Kegiatan olahraga ini tidak hanya bertujuan untuk menjaga kebugaran fisik, tetapi juga menanamkan nilai-nilai penting seperti disiplin, tanggung jawab, sportivitas, dan kerja sama antar santri. Melalui olahraga, santri belajar untuk menghargai proses, mengelola waktu dengan baik, serta membangun mental yang kuat dan fokus.
      </p>
      <p>
        Selain meningkatkan kesehatan, keolahragaan di PTQ IQRO juga menjadi sarana untuk mempererat ukhuwah antar santri. Melalui pertandingan futsal atau badminton, jogging bersama, dan tantangan workout, mereka saling mendukung dan memotivasi satu sama lain dalam suasana yang penuh semangat dan kekeluargaan.
      </p>
      <p>
        <b>Harapan kami,</b> tim keolahragaan PTQ IQRO dapat terus berkembang dengan dukungan penuh dari pihak pesantren, baik berupa penyediaan perlengkapan olahraga yang lebih memadai, fasilitas lapangan yang representatif, maupun dukungan teknis seperti pelatihan kebugaran dan manajemen olahraga. Dengan fasilitas dan dukungan yang lebih optimal, program-program olahraga akan semakin bermanfaat bagi kesehatan dan karakter santri, serta mendukung terciptanya generasi hafizh Al-Qur’an yang sehat, kuat, dan berakhlak mulia.
      </p>
    </div>
  </div>
</section>
...
.jurnalistik-hero {
  ...
  background: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)),
              url('https://ptqiqro.id/public/foto/1.jpg') center center no-repeat;
