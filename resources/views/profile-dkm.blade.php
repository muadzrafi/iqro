...
<head>
    ...
    <title>DKM - PTQ IQRO'</title>
    <link rel="icon" type="image/x-icon" href="logoptq.png">
    <meta name="title" content="Masjid Barakatul Huffaz PTQ IQRO: Pusat Ibadah dan Pengembangan Santri Multifungsi">
    <meta name="description" content="Masjid Barakatul Huffaz di PTQ IQRO berfungsi sebagai tempat ibadah, ruang belajar, pelatihan soft skill, dan aula serbaguna. Dikelola DKM aktif dengan berbagai kegiatan keagamaan dan sosial.">
    <meta name="keywords" content="Masjid Barakatul Huffaz, PTQ IQRO, masjid pesantren, DKM Masjid, kegiatan masjid, masjid multifungsi, soft skill santri, aula serbaguna pesantren">
...
<section class="jurnalistik-hero">
  ...
  <div class="container">
    <div class="hero-content">
      <h1 class="hero-title">
        <span class="hero-highlight">DKM</span><br>
        Masjid Barakatul Huffaz
      </h1>
      <p class="hero-subtitle">
        Masjid multifungsi yang menjadi jantung ibadah, belajar, dan pengembangan karakter santri serta masyarakat sekitar pesantren.
      </p>
    </div>
  </div>
</section>
  ...
  <div class="container">
    <div class="section-header">
      <h2 class="section-title">
        <span class="title-highlight">Profil</span> Masjid
        <div class="title-underline"></div>
      </h2>
    </div>
    <div class="about-content">
      <div class="about-image">
        <img src="https://ptqiqro.id/public/foto/16.jpg" alt="Masjid Barakatul Huffaz PTQ IQRO" class="featured-image">
        <div class="image-badge">
          <i class="fas fa-mosque"></i> Masjid Multifungsi
        </div>
      </div>
      <div class="about-text">
        <p class="lead-text">
          <span class="text-highlight">Masjid Barakatul Huffaz</span> di PTQ IQRO adalah pusat ibadah, pembinaan, dan pengembangan karakter santri. Selain sebagai tempat shalat berjamaah, masjid ini juga berfungsi sebagai aula serbaguna, ruang belajar, dan sarana pelatihan soft skill. Dengan kapasitas 200-300 orang, masjid ini sangat fungsional dan menjadi pengikat harmoni antara pesantren dan masyarakat sekitar.
        </p>
        <div class="features-grid">
          <div class="feature-item">
            <div class="feature-icon"><i class="fas fa-users"></i></div>
            <div class="feature-text">
              <h4>Aktivitas Santri</h4>
              <p>Tempat belajar, mengaji, pelatihan public speaking, dan pengembangan soft skill santri.</p>
            </div>
          </div>
          <div class="feature-item">
            <div class="feature-icon"><i class="fas fa-people-carry"></i></div>
            <div class="feature-text">
              <h4>Aula Serbaguna</h4>
              <p>Dipakai untuk acara besar pesantren, seperti seminar, perayaan, dan kegiatan bersama masyarakat.</p>
            </div>
          </div>
          <div class="feature-item">
            <div class="feature-icon"><i class="fas fa-praying-hands"></i></div>
            <div class="feature-text">
              <h4>Pusat Ibadah & Kegiatan DKM</h4>
              <p>Shalat berjamaah, mabit, i’tikaf, qurban, tarawih, serta mengelola keuangan & keanggotaan di bawah DKM (ketua: Syauqi Ahzami).</p>
            </div>
          </div>
          <div class="feature-item">
            ...
            <div class="feature-text">
              <h4>Bersih & Wangi</h4>
              <p>Masjid selalu bersih dan harum berkat perawatan rutin, bukhur, dan parfum, memberikan kenyamanan maksimal.</p>
            </div>
          </div>
        </div>
      </div>
...
<section class="jurnalistik-activities">
  <div class="container">
    <div class="section-header">
      <h2 class="section-title">
        <span class="title-highlight">Kegiatan</span> DKM Masjid
        <div class="title-underline"></div>
      </h2>
    </div>
    <div class="activities-grid">
      <div class="activity-card">
        <div class="activity-icon"><i class="fas fa-bed"></i></div>
        <h3>Mabit & I’tikaf</h3>
        <p>Kegiatan bermalam dan i’tikaf bersama santri untuk memperkuat spiritualitas dan kebersamaan.</p>
        <div class="activity-badge">Spiritual</div>
      </div>
      <div class="activity-card">
        <div class="activity-icon"><i class="fas fa-drumstick-bite"></i></div>
        <h3>Qurban & Idul Adha</h3>
        <p>Pelaksanaan qurban dan perayaan Idul Adha bersama warga pesantren dan pekerja Geoforce Indonesia.</p>
        <div class="activity-badge">Tahunan</div>
      </div>
      <div class="activity-card">
        <div class="activity-icon"><i class="fas fa-moon"></i></div>
        <h3>Tarawih & Ramadhan</h3>
        <p>Shalat tarawih, buka puasa bersama, dan kajian selama bulan Ramadhan, terbuka untuk seluruh jamaah.</p>
        <div class="activity-badge">Ramadhan</div>
      </div>
      <div class="activity-card">
        <div class="activity-icon"><i class="fas fa-broom"></i></div>
        <h3>Perawatan & Pengelolaan</h3>
        <p>DKM aktif membersihkan, merawat, serta mengelola struktur keuangan dan keanggotaan masjid.</p>
        <div class="activity-badge">Rutin</div>
      </div>
    </div>
  </div>
</section>
...
<!--    <div class="section-header">-->
<!--      <h2 class="section-title">-->
<!--        <span class="title-highlight">Galeri</span> Masjid-->
<!--        <div class="title-underline"></div>-->
<!--      </h2>-->
<!--      <p class="section-subtitle">Momen ibadah, kebersamaan, dan aktivitas santri serta DKM di Masjid Barakatul Huffaz</p>-->
<!--    </div>-->
<!--    <div class="gallery-grid">-->
<!--      <div class="gallery-item">-->
<!--        <img src="https://ptqiqro.id/public/foto/1.jpg" alt="Shalat Jamaah">-->
<!--        <div class="gallery-overlay">-->
<!--          <div class="gallery-info">-->
<!--            <h3>Shalat Jamaah</h3>-->
<!--            <p>Santri dan jamaah menunaikan shalat berjamaah lima waktu.</p>-->
<!--          </div>-->
<!--        </div>-->
<!--      </div>-->
<!--      <div class="gallery-item">-->
<!--        <img src="https://ptqiqro.id/public/foto/2.jpg" alt="Acara Pesantren">-->
<!--        <div class="gallery-overlay">-->
<!--          <div class="gallery-info">-->
<!--            <h3>Acara Pesantren</h3>-->
<!--            <p>Masjid difungsikan sebagai aula serbaguna untuk acara besar.</p>-->
<!--          </div>-->
<!--        </div>-->
<!--      </div>-->
<!--      <div class="gallery-item">-->
<!--        <img src="https://ptqiqro.id/public/foto/3.jpg" alt="Pelatihan Public Speaking">-->
<!--        <div class="gallery-overlay">-->
<!--          <div class="gallery-info">-->
<!--            <h3>Pelatihan Public Speaking</h3>-->
<!--            <p>Santri berlatih berbicara di depan umum di aula masjid.</p>-->
<!--          </div>-->
<!--        </div>-->
<!--      </div>-->
<!--      <div class="gallery-item">-->
<!--        <img src="https://ptqiqro.id/public/foto/4.jpg" alt="Qurban & Idul Adha">-->
<!--        <div class="gallery-overlay">-->
<!--          <div class="gallery-info">-->
<!--            <h3>Qurban & Idul Adha</h3>-->
<!--            <p>Pelaksanaan qurban dan perayaan Idul Adha bersama pesantren.</p>-->
<!--          </div>-->
<!--        </div>-->
<!--      </div>-->
<!--      <div class="gallery-item">-->
<!--        <img src="https://ptqiqro.id/public/foto/5.jpg" alt="Mabit & Itikaf">-->
<!--        <div class="gallery-overlay">-->
<!--          <div class="gallery-info">-->
<!--            <h3>Mabit & Itikaf</h3>-->
<!--            <p>Kegiatan bermalam dan i’tikaf bersama DKM dan santri.</p>-->
<!--          </div>-->
<!--        </div>-->
<!--      </div>-->
<!--      <div class="gallery-item">-->
<!--        <img src="https://ptqiqro.id/public/foto/6.jpg" alt="Bersih & Wangi">-->
<!--        <div class="gallery-overlay">-->
<!--          <div class="gallery-info">-->
<!--            <h3>Bersih & Wangi</h3>-->
<!--            <p>Masjid selalu harum dengan bukhur dan parfum, nyaman untuk ibadah.</p>-->
<!--          </div>-->
<!--        </div>-->
<!--      </div>-->
<!--    </div>-->
...
<section class="jurnalistik-narasi">
  <div class="container">
    <div class="section-header">
      <h2 class="section-title">
        <span class="title-highlight">Tentang</span> Masjid Barakatul Huffaz
        <div class="title-underline"></div>
      </h2>
    </div>
    <div class="narasi-content">
      <p>
        Masjid Barakatul Huffaz di lingkungan Pesantren Tahfizh Al-Qur’an (PTQ) IQRO bukan sekadar tempat ibadah biasa. Dari sudut pandang seorang jurnalis muda yang menyaksikan langsung aktivitas di masjid ini, saya melihat bagaimana masjid ini menjadi pusat kehidupan spiritual sekaligus ruang pengembangan potensi santri secara menyeluruh.
      </p>
      <p>
        Masjid ini digunakan oleh para santri untuk berbagai aktivitas mulai dari belajar, mengaji, hingga melatih soft skill seperti ekstrakurikuler public speaking. Kapasitasnya yang mampu menampung sekitar 200-300 orang menjadikan Masjid Barakatul Huffaz sangat fungsional, tidak hanya sebagai tempat shalat berjamaah, tetapi juga sebagai aula serbaguna untuk berbagai acara pesantren. Keberadaan masjid ini sangat vital dalam mendukung berbagai kegiatan pembinaan santri yang tidak hanya berfokus pada aspek spiritual, tetapi juga pengembangan karakter dan kemampuan sosial.
      </p>
      <p>
        Selain itu, masjid ini juga menjadi tempat ibadah bagi para pekerja Geoforce Indonesia yang gedungnya berdampingan dengan pesantren. Hal ini menunjukkan bagaimana Masjid Barakatul Huffaz berperan sebagai jembatan harmonisasi antara lingkungan pesantren dan dunia kerja di sekitarnya, memperkuat hubungan sosial dan spiritual antar komunitas.
      </p>
      <p>
        Dewan Kemakmuran Masjid (DKM) yang mengelola Masjid Barakatul Huffaz aktif menjalankan berbagai kegiatan keagamaan dan sosial. Mulai dari mabit, i’tikaf, pelaksanaan qurban, perayaan Idul Adha, hingga sholat tarawih yang rutin digelar setiap Ramadhan. Selain itu, DKM juga bertanggung jawab mengurus aspek fisik dan struktur masjid, termasuk pengelolaan keuangan dan keanggotaan. Ketua DKM saat ini, Syauqi Ahzami, memimpin dengan penuh dedikasi untuk menjaga agar masjid tetap menjadi tempat yang nyaman dan kondusif bagi semua jamaah.
      </p>
      <p>
        Salah satu hal yang membuat Masjid Barakatul Huffaz terasa istimewa adalah kebersihan dan kenyamanannya. Masjid ini selalu wangi karena rutin dibersihkan dan diberi pengharum seperti bukhur dan parfum, menciptakan suasana yang menyenangkan dan menenangkan bagi siapa saja yang beribadah atau beraktivitas di dalamnya.
      </p>
      <p>
        Melihat berbagai fungsi dan aktivitas yang berjalan di Masjid Barakatul Huffaz, jelas bahwa masjid ini bukan hanya sekadar bangunan fisik, melainkan pusat kehidupan spiritual dan sosial yang mendukung pembinaan santri secara holistik. Masjid ini menjadi tempat di mana nilai-nilai agama dipraktikkan secara nyata, sekaligus menjadi ruang pengembangan diri yang membentuk karakter santri menjadi pribadi yang berakhlak mulia, cerdas, dan siap berkontribusi bagi masyarakat.
      </p>
      <p>
        Sebagai jurnalis muda yang menyaksikan langsung dinamika di Masjid Barakatul Huffaz, saya percaya bahwa keberadaan masjid ini sangat penting bagi pesantren dan komunitas sekitarnya. Masjid ini menjadi contoh nyata bagaimana sebuah tempat ibadah dapat berperan ganda sebagai pusat pendidikan, pengembangan soft skill, dan pengikat ukhuwah antar insan. Semoga Masjid Barakatul Huffaz terus berkembang dan mendapatkan dukungan penuh agar dapat menjalankan fungsinya dengan optimal, menjadi sumber keberkahan bagi seluruh warga pesantren dan masyarakat luas.
      </p>
    </div>
  </div>
</section>
...
.jurnalistik-hero {
  ...
  background: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)),
              url('https://ptqiqro.id/public/foto/23.jpg') center center no-repeat;
