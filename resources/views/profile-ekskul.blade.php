...
<head>
    ...
    <title>Ekskul - PTQ IQRO'</title>
    <link rel="icon" type="image/x-icon" href="logoptq.png">
    <meta name="title" content="Profil PTQ IQRO’ Bekasi | Pesantren Tahfizh 30 Juz Bersanad, Ekskul & Kurikulum Akil Baligh">
    <meta name="description" content="Ekstrakurikuler PTQ IQRO menyediakan wadah bagi santri untuk mengembangkan minat dan bakat melalui berbagai kegiatan yang mendukung pembentukan karakter dan potensi diri secara optimal.">
    <meta name="keywords" content="ekstrakurikuler, PTQ IQRO, minat dan bakat santri, pengembangan santri, kegiatan pesantren, potensi santri, program ekstrakurikuler">
...
<section class="hero-section">
  ...
  <div class="container">
    <div class="hero-content" data-aos="fade-up">
      <h1 class="hero-title">
        <span class="hero-highlight">EKSKUL</span> PTQ IQRO'</h1>
      <p class="hero-subtitle">Wadah pengembangan minat dan bakat santri berbasis nilai Islami.
</p>
...
.hero-section {
  ...
  background: linear-gradient(rgba(0, 0, 0, 0.4), rgba(0, 0, 0, 0.4)), 
              url('https://ptqiqro.id/public/foto/29.jpg') center/cover no-repeat;
  display: flex;
  align-items: center;
  justify-content: center;
  color: white;
    ...
    <div class="container" style="max-width: 1200px; margin: 0 auto; padding: 0 20px;">
        <div class="content-card" style="background: white; border-radius: 15px; box-shadow: 0 10px 30px rgba(0,0,0,0.1); overflow: hidden;">
            ...
            <div class="content-header" style="background: linear-gradient(135deg, #1a7446 0%, #1a7446 70%, #fad25d 100%); padding: 30px; color: white;">
                <h3 class="content-header-title" style="margin: 0; font-size: 28px; font-weight: 700;">Kurikulum <span style="color: #fad25d;">Minat</span> dan Bakat PTQ IQRO</h3>
                <p class="content-header-subtitle" style="margin: 10px 0 0; font-size: 18px; opacity: 0.9;">Ekstrakurikuler Berbasis Nilai Islam & Keterampilan <span style="font-weight: 600; color: #fad25d;">Abad 21</span></p>
            </div>
            ...
            <div class="content-body" style="padding: 30px;">
                ...
                <div class="section-block" style="margin-bottom: 40px;">
                    ...
                    <p style="line-height: 1.8; color: #555;">
                        Ekstrakurikuler di PTQ IQRO dirancang secara khusus untuk mendukung pengembangan minat dan bakat santri dalam berbagai bidang. Dengan mengintegrasikan nilai-nilai Islam dan keterampilan hidup abad 21, PTQ IQRO berkomitmen mencetak generasi santri yang unggul, tidak hanya dalam ilmu agama, tetapi juga dalam keterampilan sosial, kreativitas, dan kepemimpinan yang kuat. Program ini menyesuaikan dengan minat dan potensi setiap santri, sehingga mereka siap menghadapi tantangan masa depan.
                    </p>
                    <div style="background: #f9f5e8; padding: 20px; border-left: 4px solid #f5b700; margin: 20px 0; border-radius: 0 5px 5px 0;">
                        <strong style="color: #1a7446;">Latar Belakang Kurikulum Minat dan Bakat Santri</strong><br>
                        <p style="margin: 10px 0 0; color: #555;">
                            Di era globalisasi, kebutuhan akan santri yang cakap dalam ilmu agama sekaligus memiliki keterampilan tambahan menjadi sangat penting. PTQ IQRO memahami perlunya wadah yang mampu menyalurkan minat dan bakat santri secara selaras dengan nilai-nilai Islam. Oleh karena itu, program ekstrakurikuler dikembangkan sebagai bagian integral dari kurikulum pendidikan holistik. Tujuannya adalah membentuk generasi muslim yang kreatif, inovatif, dan berdaya saing tinggi.
                        </p>
                    </div>
                    <p style="line-height: 1.8; color: #555;">
                        Kurikulum ini disusun berdasarkan prinsip pengembangan kecerdasan intelektual, emosional, sosial, dan spiritual. Melalui ekstrakurikuler, santri diharapkan dapat:
                    </p>
                    <ul style="padding-left: 20px; color: #555; line-height: 1.8;">
                        <li style="margin-bottom: 8px;"><span style="color: #1a7446; font-weight: bold;">✓</span> Menemukan dan mengembangkan bakat serta minat sejak dini</li>
                        <li style="margin-bottom: 8px;"><span style="color: #1a7446; font-weight: bold;">✓</span> Memiliki keterampilan yang relevan dengan kebutuhan masa depan</li>
                        <li style="margin-bottom: 8px;"><span style="color: #1a7446; font-weight: bold;">✓</span> Menjadi individu yang cerdas secara akademik dan memiliki kepribadian matang</li>
                        <li><span style="color: #1a7446; font-weight: bold;">✓</span> Siap berkontribusi positif di masyarakat</li>
                    </ul>
                </div>
                ...
                <div class="section-block" style="margin-bottom: 40px;">
                    ...
                    <div class="content-list" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 20px;">
                        <div style="background: #f9f9f9; border-radius: 8px; padding: 20px; border-top: 3px solid #1a7446;">
                            <strong style="color: #1a7446; font-size: 18px;">Meningkatkan Kreativitas</strong><br>
                            <p style="margin-top: 10px; color: #555; line-height: 1.6;">Memberikan ruang bagi santri untuk mengekspresikan ide dan inovasi dalam berbagai bidang.</p>
                        </div>
                        <div style="background: #f9f9f9; border-radius: 8px; padding: 20px; border-top: 3px solid #f5b700;">
                            <strong style="color: #1a7446; font-size: 18px;">Membangun Jiwa Kolaboratif</strong><br>
                            <p style="margin-top: 10px; color: #555; line-height: 1.6;">Mengajarkan pentingnya kerja sama tim, penyelesaian masalah bersama, dan menciptakan lingkungan yang saling mendukung.</p>
                        </div>
                        <div style="background: #f9f9f9; border-radius: 8px; padding: 20px; border-top: 3px solid #1a7446;">
                            <strong style="color: #1a7446; font-size: 18px;">Mengasah Kemampuan Komunikasi</strong><br>
                            <p style="margin-top: 10px; color: #555; line-height: 1.6;">Melatih santri agar mampu menyampaikan pemikiran dan pendapat secara lisan maupun tulisan dengan baik.</p>
                        </div>
                        <div style="background: #f9f9f9; border-radius: 8px; padding: 20px; border-top: 3px solid #f5b700;">
                            <strong style="color: #1a7446; font-size: 18px;">Menyeimbangkan Ilmu Agama dan Keterampilan Hidup</strong><br>
                            <p style="margin-top: 10px; color: #555; line-height: 1.6;">Menanamkan nilai-nilai Islam dalam berbagai aspek kehidupan agar santri mampu mengintegrasikan ajaran agama dengan keterampilan hidup.</p>
                        </div>
                        <div style="background: #f9f9f9; border-radius: 8px; padding: 20px; border-top: 3px solid #1a7446;">
                            <strong style="color: #1a7446; font-size: 18px;">Menyiapkan Santri untuk Masa Depan</strong><br>
                            <p style="margin-top: 10px; color: #555; line-height: 1.6;">Membekali santri dengan keterampilan hidup yang dapat digunakan dalam dunia kerja, wirausaha, maupun dakwah di era digital.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="section-block" style="margin-bottom: 40px;" id="visimisi">
                    <h3 class="section-title" style="font-size: 24px; color: #1a7446; margin-bottom: 20px; position: relative; padding-bottom: 10px;">
                        Program <span style="color: #f5b700;">Ekstrakurikuler</span>
                        <span style="position: absolute; bottom: 0; left: 0; width: 60px; height: 3px; background: #f5b700;"></span>
                    </h3>
                    
                    <div class="program-tabs">
                        <!-- Tab Navigation -->
                        <div class="tab-nav" style="display: flex; border-bottom: 2px solid #eee; margin-bottom: 30px;">
                            <button class="tab-btn active" onclick="openTab(event, 'wajib')" style="background: none; border: none; padding: 12px 25px; cursor: pointer; font-weight: 600; color: #1a7446; border-bottom: 3px solid #f5b700; margin-right: 10px;">Wajib</button>
                            <button class="tab-btn" onclick="openTab(event, 'pilihan')" style="background: none; border: none; padding: 12px 25px; cursor: pointer; font-weight: 600; color: #555;">Pilihan</button>
                            <button class="tab-btn" onclick="openTab(event, 'kompetensi')" style="background: none; border: none; padding: 12px 25px; cursor: pointer; font-weight: 600; color: #555;">Berdasarkan Kompetensi</button>
                        </div>
                            ...
                            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 20px;">
                                <div class="program-card" style="background: #f9f9f9; border-radius: 10px; overflow: hidden; box-shadow: 0 5px 15px rgba(0,0,0,0.05);">
                                    ...
                                    <div class="program-details" style="padding: 20px;">
                                        <h5 style="margin: 0 0 10px; color: #1a7446; font-size: 20px;">Pramuka</h5>
                                        <p style="margin: 0; color: #555; line-height: 1.6;">Melatih kemandirian, kedisiplinan, dan kepemimpinan berbasis nilai Islam.</p>
                                    </div>
                                </div>
                                ...
                                <div class="program-card" style="background: #f9f9f9; border-radius: 10px; overflow: hidden; box-shadow: 0 5px 15px rgba(0,0,0,0.05);">
                                    ...
                                    <div class="program-details" style="padding: 20px;">
                                        <h5 style="margin: 0 0 10px; color: #1a7446; font-size: 20px;">Karate</h5>
                                        <p style="margin: 0; color: #555; line-height: 1.6;">Membentuk karakter disiplin, ketahanan fisik, dan sportivitas sesuai ajaran Islam.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div id="pilihan" class="tab-content" style="display: none;">
                            <div class="program-grid" style="display: grid; grid-template-columns: repeat(auto-fill, minmax(200px, 1fr)); gap: 20px;">
                                <div class="program-item" style="background: white; border-radius: 10px; padding: 20px; text-align: center; box-shadow: 0 5px 15px rgba(0,0,0,0.05); border-top: 3px solid #f5b700; transition: transform 0.3s;">
                                    <i class="fas fa-futbol" style="font-size: 30px; color: #1a7446; margin-bottom: 10px;"></i>
                                    <span style="display: block; font-weight: 600; color: #333;">Futsal</span>
                                </div>
                                <div class="program-item" style="background: white; border-radius: 10px; padding: 20px; text-align: center; box-shadow: 0 5px 15px rgba(0,0,0,0.05); border-top: 3px solid #1a7446; transition: transform 0.3s;">
                                    <i class="fas fa-laptop-code" style="font-size: 30px; color: #1a7446; margin-bottom: 10px;"></i>
                                    <span style="display: block; font-weight: 600; color: #333;">Komputer (Microsoft Office & Coding)</span>
                                </div>
                                <div class="program-item" style="background: white; border-radius: 10px; padding: 20px; text-align: center; box-shadow: 0 5px 15px rgba(0,0,0,0.05); border-top: 3px solid #f5b700; transition: transform 0.3s;">
                                    <i class="fas fa-drum" style="font-size: 30px; color: #1a7446; margin-bottom: 10px;"></i>
                                    <span style="display: block; font-weight: 600; color: #333;">Hadroh</span>
                                </div>
                                <div class="program-item" style="background: white; border-radius: 10px; padding: 20px; text-align: center; box-shadow: 0 5px 15px rgba(0,0,0,0.05); border-top: 3px solid #1a7446; transition: transform 0.3s;">
                                    <i class="fas fa-microphone-alt" style="font-size: 30px; color: #1a7446; margin-bottom: 10px;"></i>
                                    <span style="display: block; font-weight: 600; color: #333;">Public Speaking</span>
                                </div>
                                <div class="program-item" style="background: white; border-radius: 10px; padding: 20px; text-align: center; box-shadow: 0 5px 15px rgba(0,0,0,0.05); border-top: 3px solid #f5b700; transition: transform 0.3s;">
                                    <i class="fas fa-car" style="font-size: 30px; color: #1a7446; margin-bottom: 10px;"></i>
                                    <span style="display: block; font-weight: 600; color: #333;">Otomotif</span>
                                </div>
                                <div class="program-item" style="background: white; border-radius: 10px; padding: 20px; text-align: center; box-shadow: 0 5px 15px rgba(0,0,0,0.05); border-top: 3px solid #1a7446; transition: transform 0.3s;">
                                    <i class="fas fa-pen-fancy" style="font-size: 30px; color: #1a7446; margin-bottom: 10px;"></i>
                                    <span style="display: block; font-weight: 600; color: #333;">Literasi & Jurnalistik</span>
                                </div>
                                <div class="program-item" style="background: white; border-radius: 10px; padding: 20px; text-align: center; box-shadow: 0 5px 15px rgba(0,0,0,0.05); border-top: 3px solid #f5b700; transition: transform 0.3s;">
                                    <i class="fas fa-video" style="font-size: 30px; color: #1a7446; margin-bottom: 10px;"></i>
                                    <span style="display: block; font-weight: 600; color: #333;">Media (Videografi & Fotografi)</span>
                                </div>
                                <div class="program-item" style="background: white; border-radius: 10px; padding: 20px; text-align: center; box-shadow: 0 5px 15px rgba(0,0,0,0.05); border-top: 3px solid #1a7446; transition: transform 0.3s;">
                                    <i class="fas fa-theater-masks" style="font-size: 30px; color: #1a7446; margin-bottom: 10px;"></i>
                                    <span style="display: block; font-weight: 600; color: #333;">Muhadoroh</span>
                                </div>
                            </div>
                        </div>
                        
                        <div id="kompetensi" class="tab-content" style="display: none;">
                            <div class="competency-scroll-wrapper" style="overflow-x: auto;">
                            <div class="competency-list" style="display: flex; gap: 20px; min-width: max-content;">

                                <div class="competency-item" style="background: #f9f9f9; border-radius: 10px; padding: 20px; box-shadow: 0 5px 15px rgba(0,0,0,0.05);">
                                    <h4 style="color: #1a7446; margin-top: 0; border-bottom: 2px solid #f5b700; padding-bottom: 10px; display: inline-block;">Creativity (Kreativitas)</h4>
                                    <p style="color: #555;">Mengembangkan kreativitas santri melalui:</p>
                                    <ul class="competency-sublist" style="padding-left: 20px; color: #555;">
                                        <li style="margin-bottom: 8px; position: relative; padding-left: 20px;">
                                            <span style="position: absolute; left: 0; color: #f5b700;">•</span> Kaligrafi Islam
                                        </li>
                                        <li style="margin-bottom: 8px; position: relative; padding-left: 20px;">
                                            <span style="position: absolute; left: 0; color: #f5b700;">•</span> Hadroh & Marawis
                                        </li>
                                        <li style="margin-bottom: 8px; position: relative; padding-left: 20px;">
                                            <span style="position: absolute; left: 0; color: #f5b700;">•</span> Muhadoroh (Drama Islami)
                                        </li>
                                        <li style="margin-bottom: 8px; position: relative; padding-left: 20px;">
                                            <span style="position: absolute; left: 0; color: #f5b700;">•</span> Teknologi & Coding (Pemrograman Dasar, Desain Grafis Islami)
                                        </li>
                                        <li style="margin-bottom: 8px; position: relative; padding-left: 20px;">
                                            <span style="position: absolute; left: 0; color: #f5b700;">•</span> Media (Videografi & Fotografi)
                                        </li>
                                        <li style="margin-bottom: 8px; position: relative; padding-left: 20px;">
                                            <span style="position: absolute; left: 0; color: #f5b700;">•</span> Jurnalistik & Literasi (Penulisan artikel, bulletin santri, resensi buku Islami)
                                        </li>
                                        <li style="margin-bottom: 8px; position: relative; padding-left: 20px;">
                                            <span style="position: absolute; left: 0; color: #f5b700;">•</span> Otomotif
                                        </li>
                                        <li style="position: relative; padding-left: 20px;">
                                            <span style="position: absolute; left: 0; color: #f5b700;">•</span> Futsal
                                        </li>
                                    </ul>
                                </div>
                                
                                <div class="competency-item" style="background: #f9f9f9; border-radius: 10px; padding: 20px; box-shadow: 0 5px 15px rgba(0,0,0,0.05);">
                                    <h4 style="color: #1a7446; margin-top: 0; border-bottom: 2px solid #f5b700; padding-bottom: 10px; display: inline-block;">Collaboration (Kolaborasi)</h4>
                                    <p style="color: #555;">Membangun jiwa kolaboratif melalui:</p>
                                    <ul class="competency-sublist" style="padding-left: 20px; color: #555;">
                                        <li style="margin-bottom: 8px; position: relative; padding-left: 20px;">
                                            <span style="position: absolute; left: 0; color: #f5b700;">•</span> Public Speaking
                                        </li>
                                        <li style="margin-bottom: 8px; position: relative; padding-left: 20px;">
                                            <span style="position: absolute; left: 0; color: #f5b700;">•</span> Debat & Diskusi Mini
                                        </li>
                                        <li style="margin-bottom: 8px; position: relative; padding-left: 20px;">
                                            <span style="position: absolute; left: 0; color: #f5b700;">•</span> Pelatihan Dai Cilik
                                        </li>
                                        <li style="margin-bottom: 8px; position: relative; padding-left: 20px;">
                                            <span style="position: absolute; left: 0; color: #f5b700;">•</span> Pramuka
                                        </li>
                                        <li style="margin-bottom: 8px; position: relative; padding-left: 20px;">
                                            <span style="position: absolute; left: 0; color: #f5b700;">•</span> Karate
                                        </li>
                                        <li style="position: relative; padding-left: 20px;">
                                            <span style="position: absolute; left: 0; color: #f5b700;">•</span> Proyek Kewirausahaan Santri (Produk halal, manajemen bisnis, pemasaran Islami)
                                        </li>
                                    </ul>
                                </div>
                                
                                <div class="competency-item" style="background: #f9f9f9; border-radius: 10px; padding: 20px; box-shadow: 0 5px 15px rgba(0,0,0,0.05);">
                                    <h4 style="color: #1a7446; margin-top: 0; border-bottom: 2px solid #f5b700; padding-bottom: 10px; display: inline-block;">Communication (Komunikasi)</h4>
                                    <p style="color: #555;">Mengasah keterampilan komunikasi melalui:</p>
                                    <ul class="competency-sublist" style="padding-left: 20px; color: #555;">
                                        <li style="margin-bottom: 8px; position: relative; padding-left: 20px;">
                                            <span style="position: absolute; left: 0; color: #f5b700;">•</span> Public Speaking
                                        </li>
                                ...
                                <div class="competency-item" style="background: #f9f9f9; border-radius: 10px; padding: 20px; box-shadow: 0 5px 15px rgba(0,0,0,0.05);">
                                    <h4 style="color: #1a7446; margin-top: 0; border-bottom: 2px solid #f5b700; padding-bottom: 10px; display: inline-block;">Physical Development (Pengembangan Fisik)</h4>
                                    <p style="color: #555;">Meningkatkan kesehatan dan sportivitas melalui:</p>
                                    <ul class="competency-sublist" style="padding-left: 20px; color: #555;">
                                        <li style="position: relative; padding-left: 20px;">
                                            <span style="position: absolute; left: 0; color: #f5b700;">•</span> Futsal
                                        </li>
                                ...
                                <div class="competency-item" style="background: #f9f9f9; border-radius: 10px; padding: 20px; box-shadow: 0 5px 15px rgba(0,0,0,0.05);">
                                    <h4 style="color: #1a7446; margin-top: 0; border-bottom: 2px solid #f5b700; padding-bottom: 10px; display: inline-block;">Vocational Skills (Keterampilan Kejuruan)</h4>
                                    <p style="color: #555;">Membekali santri dengan keterampilan praktis:</p>
                                    <ul class="competency-sublist" style="padding-left: 20px; color: #555;">
                                        <li style="position: relative; padding-left: 20px;">
                                            <span style="position: absolute; left: 0; color: #f5b700;">•</span> Otomotif (Perawatan & perbaikan kendaraan bermotor, teori & praktik mesin, kelistrikan, sistem kendaraan)
                                        </li>
                                    </ul>
                                </div>
                            </div>
                ...
                <div class="section-block">
                    ...
                    <div class="advantage-list" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 20px;">
                        <div class="advantage-item" style="background: #f9f9f9; padding: 20px; border-radius: 8px; box-shadow: 0 5px 15px rgba(0,0,0,0.05); border-left: 4px solid #1a7446;">
                            <strong style="color: #1a7446; display: block; margin-bottom: 10px;">Berbasis Nilai Islam:</strong> 
                            <span style="color: #555; line-height: 1.6;">Setiap kegiatan mengedepankan nilai-nilai Islami sebagai fondasi utama.</span>
                        </div>
                        <div class="advantage-item" style="background: #f9f9f9; padding: 20px; border-radius: 8px; box-shadow: 0 5px 15px rgba(0,0,0,0.05); border-left: 4px solid #f5b700;">
                            <strong style="color: #1a7446; display: block; margin-bottom: 10px;">Holistik & Terintegrasi:</strong> 
                            <span style="color: #555; line-height: 1.6;">Menyeimbangkan ilmu agama, keterampilan hidup, dan pengembangan karakter.</span>
                        </div>
                        <div class="advantage-item" style="background: #f9f9f9; padding: 20px; border-radius: 8px; box-shadow: 0 5px 15px rgba(0,0,0,0.05); border-left: 4px solid #1a7446;">
                            <strong style="color: #1a7446; display: block; margin-bottom: 10px;">Mendukung Kebutuhan Masa Depan:</strong> 
                            <span style="color: #555; line-height: 1.6;">Santri dibekali keterampilan relevan untuk dunia kerja, wirausaha, maupun dakwah digital.</span>
                        </div>
                        <div class="advantage-item" style="background: #f9f9f9; padding: 20px; border-radius: 8px; box-shadow: 0 5px 15px rgba(0,0,0,0.05); border-left: 4px solid #f5b700;">
                            <strong style="color: #1a7446; display: block; margin-bottom: 10px;">Fleksibel & Responsif:</strong> 
                            <span style="color: #555; line-height: 1.6;">Program dapat disesuaikan dengan perkembangan minat dan bakat santri.</span>
                        </div>
                    </div>
                </div>
            </div>
...
<style>
@media (max-width: 768px) {
  .competency-scroll-wrapper {
    overflow-x: auto;
    -webkit-overflow-scrolling: touch;
    scrollbar-width: thin;
    scrollbar-color: #1a7446 #f9f9f9;
    padding-bottom: 10px;
  }
