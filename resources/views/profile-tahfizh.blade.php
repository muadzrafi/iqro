...
<head>
 <meta charset="utf-8">
    ...
    <title>Tahfizh - PTQ IQRO'</title>
    <link rel="icon" type="image/x-icon" href="logoptq.png">
    <meta name="title" content="Tahfizh Al-Qur’an di PTQ IQRO’ Bekasi | Program 30 Juz Bersanad & Pembinaan Hafizh">
    <meta name="description" content="Program tahfizh Al-Qur’an di PTQ IQRO’ Bekasi: Fokus pada hafalan 30 juz bersanad, bimbingan intensif, metode hafalan efektif, serta pembinaan karakter dan akhlak santri.">
    <meta name="keywords" content="tahfizh PTQ IQRO, hafalan Qur’an Bekasi, tahfizh 30 juz, bimbingan tahfizh, pesantren tahfizh, program bersanad, metode hafalan Qur’an, pembinaan hafizh, pendidikan Islam Bekasi">
    ...
    <div class="sigma-navbar-menu">
      <ul class="sigma-main-menu">
        ...
        <li class="sigma-menu-item sigma-dropdown active">
          <a href="#" class="sigma-menu-link active">
...
<section class="hero-section">
  ...
  <div class="container">
    <div class="hero-content" data-aos="fade-up">
      <h1 class="hero-title">
        <span class="hero-highlight">TAHFIZH</span> PTQ IQRO'</h1>
      <p class="hero-subtitle">Program Tahfizh Al-Qur’an 30 Juz Bersanad dengan Metode Modern dan Pembinaan Karakter
</p>
...
.hero-section {
  ...
  background: linear-gradient(rgba(0, 0, 0, 0.4), rgba(0, 0, 0, 0.4)), 
              url('https://ptqiqro.id/public/foto/30.jpg') center/cover no-repeat;
  display: flex;
  align-items: center;
  justify-content: center;
  color: white;
    ...
    <div class="container" style="max-width: 1200px; margin: 0 auto; padding: 0 20px;">
        <div class="content-card" style="background: white; border-radius: 15px; box-shadow: 0 10px 30px rgba(0,0,0,0.1); overflow: hidden;">
            ...
            <div class="content-header" style="background: linear-gradient(135deg, #1a7446 0%, #1a7446 70%, #fad25d 100%); padding: 30px; color: white;">
                <h3 class="content-header-title" style="margin: 0; font-size: 28px; font-weight: 700;">Program <span style="color: #fad25d;">Ketahfizan</span> PTQ IQRO</h3>
                <p class="content-header-subtitle" style="margin: 10px 0 0; font-size: 18px; opacity: 0.9;">Mencetak Santri Penghafal Al-Qur'an dengan <span style="font-weight: 600; color: #fad25d;">Ruhul Qur'ani</span></p>
            </div>
            
            <div class="content-body" style="padding: 30px;" id="visimisi">
                ...
                <div class="section-block" style="margin-bottom: 40px;">
                    ...
                    <p style="line-height: 1.8; color: #555;">
                        Program Ketahfizan merupakan salah satu program unggulan di Pesantren Tahfidz Qur'an IQRO'. Program ini dirancang khusus untuk membantu para santri dalam menghafal Al-Qur'an dengan metode yang terstruktur dan efektif. Melalui program ini, Pesantren Tahfidz Qur'an IQRO' berkomitmen untuk mewujudkan visi mencetak santri yang memiliki Ruhul Qur'ani, yaitu santri yang tidak hanya mampu menghafal Al-Qur'an, tetapi juga memperbaiki bacaan (tahsin), menjaga hafalan, serta mampu mengamalkan dan mengajarkan Al-Qur'an di masyarakat.
                    </p>
                    
                    <!--<div style="background: #f9f5e8; padding: 20px; border-left: 4px solid #f5b700; margin: 20px 0; border-radius: 0 5px 5px 0;">-->
                    <!--    <strong style="color: #1a7446;">Visi Program Ketahfizan</strong><br>-->
                    <!--    <p style="margin: 10px 0 0; color: #555;">-->
                    <!--        "Mencetak generasi penghafal Al-Qur'an yang memiliki pemahaman mendalam, bacaan yang indah, dan akhlak Qur'ani yang siap menjadi pemimpin umat di masa depan."-->
                    <!--    </p>-->
                    <!--</div>-->
                ...
                <div class="section-block" style="margin-bottom: 40px;">
                    <h3 class="section-title" style="font-size: 24px; color: #1a7446; margin-bottom: 20px; position: relative; padding-bottom: 10px;">
                        Keunggulan <span style="color: #f5b700;">Program</span>
                        <span style="position: absolute; bottom: 0; left: 0; width: 60px; height: 3px; background: #f5b700;"></span>
                    </h3>
                    <div class="content-list" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 20px;">
                        <div style="background: #f9f9f9; border-radius: 8px; padding: 20px; border-top: 3px solid #1a7446;">
                            <strong style="color: #1a7446; font-size: 18px;">Fokus pada Hafalan Al-Qur'an</strong><br>
                            <p style="margin-top: 10px; color: #555; line-height: 1.6;">Santri dibimbing secara intensif untuk menghafal Al-Qur'an dengan target yang jelas dan terukur.</p>
                        </div>
                        <div style="background: #f9f9f9; border-radius: 8px; padding: 20px; border-top: 3px solid #f5b700;">
                            <strong style="color: #1a7446; font-size: 18px;">Peningkatan Kualitas Bacaan</strong><br>
                            <p style="margin-top: 10px; color: #555; line-height: 1.6;">Tidak hanya hafal, para santri juga dilatih untuk memperbaiki dan memperindah bacaan Al-Qur'an sesuai kaidah tajwid.</p>
                        </div>
                        <div style="background: #f9f9f9; border-radius: 8px; padding: 20px; border-top: 3px solid #1a7446;">
                            <strong style="color: #1a7446; font-size: 18px;">Sistem Ujian Berkala</strong><br>
                            <p style="margin-top: 10px; color: #555; line-height: 1.6;">Pesantren menerapkan sistem ujian hafalan secara rutin untuk memastikan hafalan dan bacaan santri tetap terjaga dengan baik.</p>
                        </div>
                        <div style="background: #f9f9f9; border-radius: 8px; padding: 20px; border-top: 3px solid #f5b700;">
                            <strong style="color: #1a7446; font-size: 18px;">Pembinaan Karakter</strong><br>
                            <p style="margin-top: 10px; color: #555; line-height: 1.6;">Program ini bertujuan menanamkan nilai-nilai Al-Qur'an dalam kehidupan sehari-hari para santri.</p>
                        </div>
                        <div style="background: #f9f9f9; border-radius: 8px; padding: 20px; border-top: 3px solid #1a7446;">
                            <strong style="color: #1a7446; font-size: 18px;">Pengembangan Holistik</strong><br>
                            <p style="margin-top: 10px; color: #555; line-height: 1.6;">Santri tidak hanya unggul dalam bidang akademis, tetapi juga memiliki kemampuan dalam hal-hal yang berkaitan dengan Al-Qur'an.</p>
                        </div>
                        <div style="background: #f9f9f9; border-radius: 8px; padding: 20px; border-top: 3px solid #f5b700;">
                            <strong style="color: #1a7446; font-size: 18px;">Siap Mengabdi</strong><br>
                            <p style="margin-top: 10px; color: #555; line-height: 1.6;">Lulusan program Ketahfizan diharapkan mampu mengajarkan dan menerapkan ilmu Al-Qur'an di lingkungan masyarakat.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="section-block" style="margin-bottom: 40px;">
                    <h3 class="section-title" style="font-size: 24px; color: #1a7446; margin-bottom: 20px; position: relative; padding-bottom: 10px;">
                        Metode <span style="color: #f5b700;">Ketahfizan</span>
                        <span style="position: absolute; bottom: 0; left: 0; width: 60px; height: 3px; background: #f5b700;"></span>
                    </h3>
                    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 20px;">
                        <div style="background: #f9f9f9; border-radius: 10px; overflow: hidden; box-shadow: 0 5px 15px rgba(0,0,0,0.05);">
                            ...
                            <div class="program-details" style="padding: 20px;">
                                <h5 style="margin: 0 0 10px; color: #1a7446; font-size: 20px;">Baligho</h5>
                                <p style="margin: 0; color: #555; line-height: 1.6;">Belajar langsung dengan ustadz/ustadzah untuk memastikan bacaan dan hafalan sesuai dengan kaidah yang benar.</p>
                            </div>
                        </div>
                        ...
                        <div style="background: #f9f9f9; border-radius: 10px; overflow: hidden; box-shadow: 0 5px 15px rgba(0,0,0,0.05);">
                            ...
                            <div class="program-details" style="padding: 20px;">
                                <h5 style="margin: 0 0 10px; color: #1a7446; font-size: 20px;">Muraja'ah Berkelompok</h5>
                                <p style="margin: 0; color: #555; line-height: 1.6;">Sesi pengulangan hafalan dalam kelompok kecil untuk memperkuat hafalan dan membangun kebersamaan.</p>
                            </div>
                        </div>
                        ...
                        <div style="background: #f9f9f9; border-radius: 10px; overflow: hidden; box-shadow: 0 5px 15px rgba(0,0,0,0.05);">
                            ...
                            <div class="program-details" style="padding: 20px;">
                                <h5 style="margin: 0 0 10px; color: #1a7446; font-size: 20px;">Tasmi'</h5>
                                <p style="margin: 0; color: #555; line-height: 1.6;">Metode mendengarkan bacaan dari qari' profesional untuk melatih pengucapan dan melodi bacaan.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="section-block">
                    <h3 class="section-title" style="font-size: 24px; color: #1a7446; margin-bottom: 20px; position: relative; padding-bottom: 10px;">
                        Target <span style="color: #f5b700;">Program</span>
                        <span style="position: absolute; bottom: 0; left: 0; width: 60px; height: 3px; background: #f5b700;"></span>
                    </h3>
                    <div class="advantage-list" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 20px;">
                        <div class="advantage-item" style="background: #f9f9f9; padding: 20px; border-radius: 8px; box-shadow: 0 5px 15px rgba(0,0,0,0.05); border-left: 4px solid #1a7446;">
                            <strong style="color: #1a7446; display: block; margin-bottom: 10px;">Hafalan Juz 30</strong> 
                            <span style="color: #555; line-height: 1.6;">Target minimal bagi santri pemula dalam program ketahfizan.</span>
                        </div>
                        <div class="advantage-item" style="background: #f9f9f9; padding: 20px; border-radius: 8px; box-shadow: 0 5px 15px rgba(0,0,0,0.05); border-left: 4px solid #f5b700;">
                            <strong style="color: #1a7446; display: block; margin-bottom: 10px;">Hafalan 5 Juz</strong> 
                            <span style="color: #555; line-height: 1.6;">Target menengah untuk santri yang telah melewati tahap pemula.</span>
                        </div>
                        <div class="advantage-item" style="background: #f9f9f9; padding: 20px; border-radius: 8px; box-shadow: 0 5px 15px rgba(0,0,0,0.05); border-left: 4px solid #1a7446;">
                            <strong style="color: #1a7446; display: block; margin-bottom: 10px;">Hafalan 30 Juz</strong> 
                            <span style="color: #555; line-height: 1.6;">Target utama bagi santri yang serius menekuni program tahfiz.</span>
                        </div>
                    </div>
                    
                    <div style="margin-top: 30px; background: #f0f7f4; padding: 20px; border-radius: 8px; text-align: center;">
                        <h4 style="color: #1a7446; margin-top: 0;">Kesimpulan</h4>
                        <p style="color: #555; line-height: 1.7; margin-bottom: 0;">
                            Dengan mengikuti Program Ketahfizan di Pesantren Tahfidz Qur'an IQRO', para santri tidak hanya menjadi penghafal Al-Qur'an yang berkualitas, tetapi juga siap menjadi generasi Qur'ani yang mampu memberikan kontribusi positif bagi masyarakat.
                        </p>
                    </div>
                </div>
            </div>
