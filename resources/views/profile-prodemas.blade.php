...
<head>
    ...
    <title>Prodemas - PTQ IQRO'</title>
    <link rel="icon" type="image/x-icon" href="logoptq.png">
    <meta name="title" content="PRODEMAS PTQ IQRO: Pengabdian Masyarakat, Pembentukan Karakter Santri">
    <meta name="description" content="PRODEMAS PTQ IQRO: Program pengabdian masyarakat yang melatih kepekaan sosial, kepemimpinan, dan kontribusi nyata santri untuk umat.">
    <meta name="keywords" content="PRODEMAS, PTQ IQRO, pengabdian masyarakat, kegiatan sosial santri, pesantren, pembentukan karakter, aksi sosial, santri peduli, program pesantren">
...
<section class="jurnalistik-hero">
  ...
  <div class="container">
    <div class="hero-content">
      <h1 class="hero-title">
        <span class="hero-highlight">PRODEMAS</span><br>
        Program Dedikasi Masyarakat PTQ IQRO
      </h1>
      <p class="hero-subtitle">
        Mengukir Jejak Pengabdian, Membentuk Generasi Qurani yang Peduli dan Berkontribusi
      </p>
      <div class="social-links">
        <a href="https://www.instagram.com/prodemas_2025?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==" class="social-link instagram"><i class="fab fa-instagram"></i></a>
      </div>
    </div>
  </div>
</section>
  ...
  <div class="container">
    <div class="section-header">
      <h2 class="section-title">
        <span class="title-highlight">Profil</span> PRODEMAS
        <div class="title-underline"></div>
      </h2>
    </div>
    <div class="about-content">
      <div class="about-image">
        <img src="https://ptqiqro.id/public/foto/18.jpg" alt="PRODEMAS PTQ IQRO" class="featured-image">
        <div class="image-badge">
          <i class="fas fa-hands-helping"></i> Pengabdian Masyarakat
        </div>
      </div>
      <div class="about-text">
        <p class="lead-text">
          <span class="text-highlight">PRODEMAS</span> (Program Dedikasi Masyarakat) adalah program pengabdian masyarakat yang menjadi ciri khas PTQ IQRO untuk santri tingkat SMA. Melalui PRODEMAS, santri terjun langsung ke masyarakat, mengaplikasikan ilmu pesantren, dan memberikan kontribusi nyata bagi lingkungan sekitar.
        </p>
        <div class="features-grid">
          <div class="feature-item">
            <div class="feature-icon"><i class="fas fa-broom"></i></div>
            <div class="feature-text">
              <h4>Pembersihan Fasilitas Umum</h4>
              <p>Santri bersama masyarakat membersihkan masjid, mushola, sekolah, dan lingkungan sekitar sebagai bentuk kepedulian bersama.</p>
            </div>
          </div>
          <div class="feature-item">
            <div class="feature-icon"><i class="fas fa-bullhorn"></i></div>
            <div class="feature-text">
              <h4>Penyuluhan & Edukasi</h4>
              <p>Mengadakan penyuluhan kesehatan, kebersihan, dan pengajaran Al-Qur’an untuk anak-anak dan remaja di lingkungan sekitar.</p>
            </div>
          </div>
          <div class="feature-item">
            <div class="feature-icon"><i class="fas fa-hands"></i></div>
            <div class="feature-text">
              <h4>Aksi Sosial & Bantuan</h4>
              <p>Menyalurkan bantuan kepada masyarakat yang membutuhkan serta mengadakan kegiatan sosial seperti santunan dan bakti sosial.</p>
            </div>
          </div>
          <div class="feature-item">
            ...
            <div class="feature-text">
              ...
              <p>Melatih kepemimpinan, tanggung jawab, dan kepekaan sosial santri melalui interaksi langsung dengan masyarakat.</p>
            </div>
          </div>
        </div>
      </div>
...
<section class="jurnalistik-activities">
  <div class="container">
    <div class="section-header">
      <h2 class="section-title">
        <span class="title-highlight">Kegiatan</span> PRODEMAS
        <div class="title-underline"></div>
      </h2>
    </div>
    <div class="activities-grid">
      <div class="activity-card">
        ...
        <h3>Pembersihan Fasilitas Umum</h3>
        <p>Bersama masyarakat, santri membersihkan masjid, mushola, dan lingkungan sekitar sebagai bentuk kepedulian sosial.</p>
        <div class="activity-badge">Aksi Nyata</div>
      </div>
      <div class="activity-card">
        <div class="activity-icon"><i class="fas fa-chalkboard-teacher"></i></div>
        <h3>Penyuluhan & Edukasi</h3>
        <p>Mengadakan penyuluhan kesehatan, kebersihan, serta pengajaran Al-Qur’an dan ilmu agama untuk masyarakat.</p>
        <div class="activity-badge">Edukasi</div>
      </div>
      <div class="activity-card">
        <div class="activity-icon"><i class="fas fa-hand-holding-heart"></i></div>
        <h3>Aksi Sosial & Bantuan</h3>
        <p>Menyalurkan bantuan, santunan, dan mengadakan bakti sosial untuk masyarakat yang membutuhkan.</p>
        <div class="activity-badge">Bakti Sosial</div>
      </div>
      <div class="activity-card">
        <div class="activity-icon"><i class="fas fa-users"></i></div>
        <h3>Pembinaan Karakter</h3>
        <p>Melatih kepemimpinan, tanggung jawab, dan kerja sama santri melalui interaksi dan kolaborasi di masyarakat.</p>
        <div class="activity-badge">Pembinaan</div>
      </div>
    </div>
  </div>
</section>
...
<!--    <div class="section-header">-->
<!--      <h2 class="section-title">-->
<!--        <span class="title-highlight">Galeri</span> PRODEMAS-->
<!--        <div class="title-underline"></div>-->
<!--      </h2>-->
<!--      <p class="section-subtitle">Momen-momen pengabdian dan aksi sosial santri PTQ IQRO dalam program PRODEMAS</p>-->
<!--    </div>-->
<!--    <div class="gallery-grid">-->
<!--      <div class="gallery-item">-->
<!--        <img src="https://ptqiqro.id/public/foto/1.jpg" alt="Pembersihan Masjid">-->
<!--        <div class="gallery-overlay">-->
<!--          <div class="gallery-info">-->
<!--            <h3>Pembersihan Masjid</h3>-->
<!--            <p>Santri dan masyarakat bersama-sama membersihkan masjid lingkungan.</p>-->
<!--          </div>-->
<!--        </div>-->
<!--      </div>-->
<!--      <div class="gallery-item">-->
<!--        <img src="https://ptqiqro.id/public/foto/2.jpg" alt="Penyuluhan Kesehatan">-->
<!--        <div class="gallery-overlay">-->
<!--          <div class="gallery-info">-->
<!--            <h3>Penyuluhan Kesehatan</h3>-->
<!--            <p>Penyuluhan dan edukasi pentingnya hidup sehat bagi warga sekitar.</p>-->
<!--          </div>-->
<!--        </div>-->
<!--      </div>-->
<!--      <div class="gallery-item">-->
<!--        <img src="https://ptqiqro.id/public/foto/3.jpg" alt="Pengajaran Al-Qur'an">-->
<!--        <div class="gallery-overlay">-->
<!--          <div class="gallery-info">-->
<!--            <h3>Pengajaran Al-Qur'an</h3>-->
<!--            <p>Santri mengajar ngaji dan ilmu agama kepada anak-anak dan remaja.</p>-->
<!--          </div>-->
<!--        </div>-->
<!--      </div>-->
<!--      <div class="gallery-item">-->
<!--        <img src="https://ptqiqro.id/public/foto/4.jpg" alt="Bakti Sosial">-->
<!--        <div class="gallery-overlay">-->
<!--          <div class="gallery-info">-->
<!--            <h3>Bakti Sosial</h3>-->
<!--            <p>Penyaluran bantuan dan santunan untuk masyarakat yang membutuhkan.</p>-->
<!--          </div>-->
<!--        </div>-->
<!--      </div>-->
<!--      <div class="gallery-item">-->
...
<!--      </div>-->
<!--      <div class="gallery-item">-->
<!--        <img src="https://ptqiqro.id/public/foto/5.jpg" alt="Pembinaan Karakter">-->
<!--        <div class="gallery-overlay">-->
<!--          <div class="gallery-info">-->
<!--            <h3>Pembinaan Karakter</h3>-->
<!--            <p>Melatih kepemimpinan dan kepekaan sosial santri melalui interaksi langsung.</p>-->
<!--          </div>-->
<!--        </div>-->
<!--      </div>-->
<!--    </div>-->
...
<section class="jurnalistik-narasi">
  <div class="container">
    <div class="section-header">
      <h2 class="section-title">
        <span class="title-highlight">Tentang</span> PRODEMAS PTQ IQRO
        <div class="title-underline"></div>
      </h2>
    </div>
    <div class="narasi-content">
      <p>
        PRODEMAS (Program Dedikasi Masyarakat) merupakan salah satu program unggulan PTQ IQRO yang dirancang untuk membentuk generasi Qurani yang peduli dan siap berkontribusi nyata bagi masyarakat. Melalui PRODEMAS, santri tingkat SMA terjun langsung ke lingkungan sekitar, mengaplikasikan ilmu yang didapatkan di pesantren, dan belajar memahami berbagai permasalahan sosial secara langsung.
      </p>
      <p>
        Kegiatan PRODEMAS sangat beragam, mulai dari pembersihan fasilitas umum seperti masjid dan sekolah, penyuluhan kesehatan dan kebersihan, pengajaran Al-Qur’an dan ilmu agama, pendampingan belajar, hingga aksi sosial berupa santunan dan bantuan kepada masyarakat yang membutuhkan. Setiap kegiatan dirancang untuk menanamkan nilai kepedulian, tanggung jawab, dan jiwa kepemimpinan pada diri santri.
      </p>
      <p>
        PRODEMAS bukan sekadar aksi sosial, tetapi juga sarana pembentukan karakter santri. Melalui interaksi langsung dengan masyarakat, santri dilatih untuk berkomunikasi, bekerja sama, dan mengaplikasikan nilai-nilai Islam dalam kehidupan nyata. Pengalaman ini menjadi bekal berharga bagi santri untuk menjadi pemimpin masa depan yang berakhlak mulia dan bermanfaat bagi umat.
      </p>
      <p>
        PTQ IQRO percaya bahwa PRODEMAS adalah investasi masa depan umat. Dengan mengikuti program ini, santri tidak hanya menjadi hafizh Al-Qur'an yang mutqin, tetapi juga kader yang memiliki kepedulian sosial tinggi dan siap berkontribusi positif bagi masyarakat. Mari dukung dan sukseskan PRODEMAS untuk membangun generasi Qurani yang peduli, berdaya, dan menginspirasi!
      </p>
    </div>
  </div>
</section>
...
.jurnalistik-hero {
  ...
  background: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)),
              url('https://ptqiqro.id/public/foto/18.jpg') center center no-repeat;
